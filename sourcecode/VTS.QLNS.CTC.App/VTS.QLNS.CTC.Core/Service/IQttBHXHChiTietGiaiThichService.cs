...
{
    public interface IQttBHXHChiTietGiaiThichService
    {
        BhQttBHXHChiTietGiaiThich FindByCondition(BhQttBHXHChiTietGiaiThichCriteria condition);
        void Add(BhQttBHXHChiTietGiaiThich chungTuChiTietGiaiThich);
        BhQttBHXHChiTietGiaiThich FindById(Guid id);
        void Update(BhQttBHXHChiTietGiaiThich chungTuChiTietGiaiThich);
        IEnumerable<BhQttBHXHChiTietGiaiThichQuery> GetChiTietGiaiThichTruyThu(BhQttBHXHChiTietGiaiThichCriteria condition);
        int AddRange(IEnumerable<BhQttBHXHChiTietGiaiThich> chungTuChiTiets);
        ...
        int RemoveRange(IEnumerable<BhQttBHXHChiTietGiaiThich> chiTiets);
        ...
        BhQttBHXHChiTietGiaiThichQuery ExportGiaiThichBangLoi(int namLamViec, int quy, int loaiQuy, string maDonVi, string maLoaiThu);
