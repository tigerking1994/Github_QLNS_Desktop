...
{
    public class TlBangLuongThangService : ITlBangLuongThangService
    {
        private readonly ITlBangLuongThangRepository _tlBangLuongThangRepository;
        ...
        private readonly ITlDmCapBacRepository _tlDmCapBacRepository;
        private readonly ITlBaoCaoRepository _tlBaoCaoRepository;
        private readonly ITlCanBoPhuCapRepository _tlCanBoPhuCapRepository;
        private readonly ITlQsChungTuChiTietRepository _tlQsChungTuChiTietRepository;
        private readonly ITlQsChungTuRepository _tlQsChungTuRepository;
        private readonly ITlDmPhuCapRepository _tlDmPhuCapRepository;
        private readonly ITlDmThueThuNhapCaNhanRepository _tlDmThueThuNhapCaNhanRepository;

        public TlBangLuongThangService(ITlBangLuongThangRepository tlBangLuongThangRepository,
            ITlDmCanBoRepository tlDmCanboRepository, ITlDmDonViRepository tlDmDonViRepository,
            ITlDmCapBacService tlDmCapBacService, ITlDmCapBacRepository tlDmCapBacRepository,
            ITlBaoCaoRepository tlBaoCaoRepository,
            ITlCanBoPhuCapRepository tlCanBoPhuCapRepository,
            ITlQsChungTuChiTietRepository tlQsChungTuChiTietRepository,
            ITlQsChungTuRepository tlQsChungTuRepository,
            ITlDmPhuCapRepository tlDmPhuCapRepository,
        ...
        public int Add(IEnumerable<TlBangLuongThang> entity)
        {
            return _tlBangLuongThangRepository.AddRange(entity);
        }

        public IEnumerable<TlDmCanBo> FindCbLuong(decimal? thang, decimal? nam, string maDonVi)
        {
            return _tlBangLuongThangRepository.FindCb(thang, nam, maDonVi);
        }

        public IEnumerable<TlDmThueThuNhapCaNhan> FindThue(bool bIsThueThang = true)
        {
            return _tlBangLuongThangRepository.FindThue(bIsThueThang);
        }

        public int AddRange(IEnumerable<TlBangLuongThang> entities)
        {
            return _tlBangLuongThangRepository.AddRange(entities);
        }

        public int AddOrUpdateRange(IEnumerable<TlBangLuongThang> entities)
        {
            return _tlBangLuongThangRepository.AddOrUpdateRange(entities);
        }

        public int UpdateRange(IEnumerable<TlBangLuongThang> entities)
        {
            return _tlBangLuongThangRepository.UpdateRange(entities);
        }
        public int Delete(TlBangLuongThang entity)
        {
            return _tlBangLuongThangRepository.Delete(entity);
        }

        public int Update(TlBangLuongThang entity)
        {
        ...
        public IEnumerable<TlBangLuongThang> FindByParentId(Guid parentId)
        {
            return _tlBangLuongThangRepository.FindByParentId(parentId);
        }

        public IEnumerable<TlBangLuongThang> FindByCondition(Expression<Func<TlBangLuongThang, bool>> predicate)
        {
        ...
        public DataTable ReportBangKeTrichThueTNCN(int thang, int nam, string maCachTl, string maDonVi, int donViTinh, bool isExportAll, bool isOrderChucVu)
        {
            ...
            foreach (DataRow item in result.Rows)
            {
                ...
                {
                    var tmpTinhThue = item["TINHTHUE"];
                    if (!(tmpTinhThue is DBNull))
                    {
        ...
        public DataTable ReportBangKeTrichThueTNCNSummary(int thang, int nam, string maCachTl, List<TlDmDonVi> tlDmDonVis, int donViTinh, bool isExportAll, bool isOrderChucVu)
        {
                ...
                foreach (var item in dicDonVi)
                {
                    ...
                    if (rowDetails.Any())
                    {
                        ...
                        foreach (DataRow dataRow in rowDetails)
                        {
                            ...
                            var tmpTinhThue = dataRow["TINHTHUE"];
                            if (!(tmpTinhThue is DBNull))
                            {
        ...
        public DataTable ReportBangLuongTruyLinhDongPhuCap(List<TlDmDonVi> lstDonVi, List<TlDmPhuCap> lstPhuCap, int nam, int thang, string maCachTl, bool isTruyLinh, int donViTinh, bool isOrderChucVu)
        {
            ...
            if (isTruyLinh) condition = string.Format(" {0} > 0 ", PhuCap.THANHTIEN);
        ...
        public Dictionary<string, List<ReportBangLuongTruyLinhDongPhuCapQuery>> ReportBangLuongTruyLinhDongPhuCap(DataTable data, TlDmDonVi donVi, List<TlDmPhuCap> lstPhuCap, bool isTruyLinh)
        {
            var dicResult = new Dictionary<string, List<ReportBangLuongTruyLinhDongPhuCapQuery>>();
            List<ReportBangLuongTruyLinhDongPhuCapQuery> results = new List<ReportBangLuongTruyLinhDongPhuCapQuery>();
            List<ReportBangLuongTruyLinhDongPhuCapQuery> itemTotal = new List<ReportBangLuongTruyLinhDongPhuCapQuery>();
            ...
            if (subRows.Any())
            {
                ...
                {
                    ReportBangLuongTruyLinhDongPhuCapQuery itemDetail = new ReportBangLuongTruyLinhDongPhuCapQuery();
                    ...
                    itemDetail.LstGiaTri = new List<GiaTriTruyLinhDong>();

                    GiaTriTruyLinhDong dynamicItemDetail;
                    foreach (var phuCap in lstPhuCap)
                    {
                        dynamicItemDetail = new GiaTriTruyLinhDong();
                ...
                ReportBangLuongTruyLinhDongPhuCapQuery itTotal = new ReportBangLuongTruyLinhDongPhuCapQuery();
                itTotal.LstGiaTriTotal = new List<GiaTriTruyLinhDong>();
                GiaTriTruyLinhDong gtTotal;
                foreach (var phuCap in lstPhuCap)
                {
                    gtTotal = new GiaTriTruyLinhDong();
        ...
        public Dictionary<string, List<ReportBangLuongTruyLinhDongPhuCapQuery>> ReportBangLuongTruyLinhDongPhuCapSummary(DataTable data, List<TlDmPhuCap> lstPhuCap, bool isTruyLinh)
        {
            var dicResult = new Dictionary<string, List<ReportBangLuongTruyLinhDongPhuCapQuery>>();
            List<ReportBangLuongTruyLinhDongPhuCapQuery> results = new List<ReportBangLuongTruyLinhDongPhuCapQuery>();
            List<ReportBangLuongTruyLinhDongPhuCapQuery> itemTotal = new List<ReportBangLuongTruyLinhDongPhuCapQuery>();
        ...
        public DataTable ReportGiaiThichChiTietPhuCapHsqCs(List<TlDmDonVi> lstDonVi, int nam, int thang, int donViTinh)
        {
            string maDonVi = string.Join(",", lstDonVi.Select(x => x.MaDonVi));
            return _tlBangLuongThangRepository.GetDataReportGiaiThichChiTietHsqCs(maDonVi, nam, thang, donViTinh);
        }

        public DataTable GetDataReportDanhSachChiTraNganHang(List<TlDmDonVi> lstDonVi, int nam, int thang, bool isReduceBHXH)
        {
            string maDonVi = string.Join(",", lstDonVi.Select(x => x.MaDonVi));
            return _tlBangLuongThangRepository.GetDataReportDanhSachChiTraNganHang(maDonVi, nam, thang, isReduceBHXH);
        }

        public DataTable ReportDanhSachChiTraNganHang(int nam, int thang, int donViTinh, string sNoiDung, bool isReduceBHXH, params TlDmDonVi[] tlDmDonVis)
        {
            var data = _tlBangLuongThangRepository.RptDSChiTraCaNhanNganHang(nam, thang, tlDmDonVis.ToList(), isReduceBHXH);
            int index = 1;
        ...
        public DataTable ReportDanhSachChiTraNganHangTongHopTheoDonVi(int nam, int thang, int donViTinh, string sNoiDung, bool isReduceBHXH, List<TlDmDonVi> tlDmDonVis)
        {
            var data = _tlBangLuongThangRepository.RptDSChiTraCaNhanNganHang(nam, thang, tlDmDonVis, isReduceBHXH);
            if (data != null && data.Rows.Count > 0)
            {
                ...
                foreach (var donvi in tlDmDonVis)
                {
                    ...
                    if (row != null)
                    {
                        ...
                        decimal tongTien = Math.Ceiling(Convert.ToDecimal(data.Compute(countExpression, filter))) / donViTinh;
        ...
        public DataTable ReportDanhSachChiTraNganHang(TlDmDonVi donVi, DataTable data, int donViTinh, bool isSummary, bool isShowName)
        {
            var lstDonVi = new List<TlDmDonVi>() { donVi };
            return ReportDanhSachChiTraNganHang(lstDonVi, data, donViTinh, isSummary, isShowName);
        }

        public DataTable ReportDanhSachChiTraNganHang(List<TlDmDonVi> lstDonVi, DataTable data, int donViTinh, bool isSummary, bool isShowName)
        {
        ...
        public DataTable ReportDanhSachChiTraNganHangCaNhan(List<TlDmDonVi> lstDonVi, DataTable data, int donViTinh, bool isSummary, bool isShowName)
        {
            // Create table results
            DataTable rs = new DataTable();
            rs.Columns.Add(ExportColumnHeader.IS_PARENT, typeof(bool));
        ...
        public DataTable ReportThueThuNhapCaNhanNam(string maDonVi, int donViTinh, bool printAll, int Nam, bool isOrderChucVu)
        {
            ...
            if (results != null && results.Rows.Count > 0)
            {
                ...
                foreach (DataRow dataRow in results.Rows)
                {
                    ...
                    if (!printAll)
                    {
                        var tmpTinhThueNam = dataRow[PhuCap.THUETNCN_NAM];
                        if (!(tmpTinhThueNam is DBNull))
                        {
        ...
        public DataTable ReportThueThuNhapCaNhanNamSummary(List<TlDmDonVi> lstDonVi, int donViTinh, bool printAll, int Nam, bool isOrderChucVu)
        {
        ...
        public DataTable ReportGiaiThichChiTietPhuCapTNVKTHD(List<TlDmDonVi> lstDonVi, int nam, int thang, string maCachTl, int donViTinh)
        {
            DataTable rs = new DataTable();
            string maDonVi = string.Join(",", lstDonVi.Select(x => x.MaDonVi));
        ...
        public DataTable GetDataBangLuongThang(List<TlDmDonVi> listDonVi, int thang, int nam, bool isOrderChucVu, bool isGiaTriAm, bool isCheckedMaHuongLuong, bool isInCanBoMoi = false, bool isReduceBackPay = false)
        {
            string maDonVi = string.Join(",", listDonVi.Select(x => x.MaDonVi));
            return _tlBangLuongThangRepository.ReportBangLuongThang(maDonVi, thang, nam, isOrderChucVu, isGiaTriAm, isCheckedMaHuongLuong, isInCanBoMoi, isReduceBackPay);
        }

        public DataTable ReportBangLuongThangDong(List<TlDmDonVi> listDonVi, int thang, int nam, bool isOrderChucVu, List<string> lstColumnInclude)
        {
            string maDonVi = string.Join(",", listDonVi.Select(x => x.MaDonVi));
            return _tlBangLuongThangRepository.ReportBangLuongThangDong(maDonVi, thang, nam, isOrderChucVu, lstColumnInclude);
        }

        public DataTable GetDataBangLuongThangTheoDonVi(List<TlDmDonVi> listDonVi, int thang, int nam, bool isOrderChucVu, bool isGiaTriAm, bool isCheckedMaHuongLuong)
        {
            string maDonVi = string.Join(",", listDonVi.Select(x => x.MaDonVi));
            return _tlBangLuongThangRepository.ReportBangLuongThangTheoDonVi(maDonVi, thang, nam, isOrderChucVu, isGiaTriAm, isCheckedMaHuongLuong);
        }

        public DataTable GetDataDanhSachCapPhat(List<TlDmDonVi> listDonVi, int thang, int nam)
        {
            string maDonVi = string.Join(",", listDonVi.Select(x => x.MaDonVi));
            return _tlBangLuongThangRepository.ReportDanhSachCapPhatPhuCap(maDonVi, thang, nam);
        }

        public DataTable GetDataBangLuongTruyLinh(List<TlDmDonVi> listDonVi, int thang, int nam, bool isTruyLinh, bool isOrderChucVu)
        {
            string maDonVi = string.Join(",", listDonVi.Select(x => x.MaDonVi));
            return _tlBangLuongThangRepository.ReportBangLuongTruyLinh(maDonVi, thang, nam, isTruyLinh, isOrderChucVu);
        }

        public DataTable ReportBangLuongThang(TlDmDonVi donVi, DataTable data, int donViTinh, bool isOrderChucVu, Dictionary<string, string> dsNgach)
        {
        ...
        public DataTable ReportBangLuongThangDoc(TlDmDonVi donVi, DataTable data)
        {
            var subData = data.Select(string.Format("MaDonVi='{0}'", donVi.MaDonVi));
            if (subData.Any())
            {
        ...
        public DataTable ReportBangLuongTruyLinh(TlDmDonVi donVi, DataTable data, int donViTinh)
        {
            var subData = data.Select(string.Format("MaDonVi='{0}'", donVi.MaDonVi));
            if (subData.Any())
            {
        ...
        public DataTable ReportBangLuongThang(List<TlDmDonVi> listDonVi, int thang, int nam, int donViTinh, bool isOrderChucVu, bool isGiaTriAm, Dictionary<string, string> dsNgach, bool IsCheckedMaHuongLuong, bool isReduceBHXH)
        {
            ...
            {
                data = GetDataBangLuongThang(listDonVi, thang, nam, isOrderChucVu, isGiaTriAm, IsCheckedMaHuongLuong);
            }
            //return ReportBangLuongThangCoTenDonVi(listDonVi, data, donViTinh, dsNgach);
            return ReportBangLuongThang(data, donViTinh, dsNgach);
        }

        public DataTable ReportBangLuongThangTheoDonVi(List<TlDmDonVi> listDonVi, int thang, int nam, int donViTinh, bool isOrderChucVu, bool isGiaTriAm, Dictionary<string, string> dsNgach, bool IsCheckedMaHuongLuong, bool isReduceBHXH)
        {
            DataTable data = new DataTable();
            if (isReduceBHXH)
            {
            ...
            {
                data = GetDataBangLuongThangTheoDonVi(listDonVi, thang, nam, isOrderChucVu, isGiaTriAm, IsCheckedMaHuongLuong);
            }
            ...
            if (data != null && data.Rows.Count > 0)
            {
                ...
                foreach (var item in dsNgach)
                {
                    ...
                    if (soCanBo > 0)
                    {
                        ...
                        {
                            rowParent[ExportColumnHeader.THANH_TIEN_TAI_DV] = Math.Ceiling((decimal)valueTaiDV);
                        }
                        ...
                        {
                            rowParent[ExportColumnHeader.THANH_TIEN_QUA_TK] = Math.Ceiling((decimal)valueQuaTK);
                        }
        ...
        public DataTable ReportBangLuongThangTheoDonVi(List<TlDmDonVi> listDonVi, DataTable data, int donViTinh, Dictionary<string, string> dsNgach)
        {
            DataTable rs = new DataTable();
            if (data != null && data.Rows.Count > 0)
            {
                ...
                foreach (var donvi in listDonVi)
                {
                    ...
                    string filterDonVi = string.Format("{0} LIKE '{1}' AND ({2} LIKE '1%' OR {3} LIKE '2%' OR {4} LIKE '3%')"
                        , ExportColumnHeader.MADONVI, donvi.MaDonVi, ExportColumnHeader.XAU_NOI_MA, ExportColumnHeader.XAU_NOI_MA, ExportColumnHeader.XAU_NOI_MA);
                    ...
                    {
                        rowParentDonVi[ExportColumnHeader.THANH_TIEN_TAI_DV] = Math.Ceiling((decimal)valueTaiDVTongDonVi);
                    }
                    ...
                    {
                        rowParentDonVi[ExportColumnHeader.THANH_TIEN_QUA_TK] = Math.Ceiling((decimal)valueQuaTKTongDonVi);
                    }
                ...
                for (int i = 0; i < data.Rows.Count; i++)
                {
                    ...
                    foreach (DataColumn column in columns)
                    {
                        ...
                        else if (column.DataType == typeof(decimal))
                        {
                            ...
                            {
                                decimal val = decimal.Parse(value.ToString());
                                rowData[columnName] = Math.Ceiling(val);
                            }
                        }
                        rowDetail[columnName] = rowData[columnName];
                    }
                                ...
                                foreach (DataColumn column in columns)
                                {
                                    ...
                                    else if (PhuCap.TTL.Equals(columnName) || PhuCap.TTL_LHT.Equals(columnName) || PhuCap.TTL_PCCV.Equals(columnName) || PhuCap.TTL_PCCOV.Equals(columnName))
                                    {
                                        ...
                                        if (value != DBNull.Value)
                                        {
                                            ...
                                            if (val != 0)
                                            {
                                                rowData[columnName] = decimal.Parse(val.ToString("G29"));
                                            }
                                            else
                                            {
                                                rowData[columnName] = DBNull.Value;
        ...
        public DataTable GetDataReportGiaiThichLuongChiTiet(List<TlDmDonVi> lstDonVi, int thang, int nam, string maCachTl, int donViTinh, bool isSummary)
        {
            string maDonVi = string.Join(",", lstDonVi.Select(x => x.MaDonVi));
        ...
        public DataTable ReportGiaiThichLuongChiTiet(TlDmDonVi donVi, DataTable data, string maCachTl)
        {
            var subData = data.Select(string.Format("MaDonVi='{0}'", donVi.MaDonVi));
            if (subData.Any())
            {
        ...
        public DataTable ReportInKiem(int nam, int thang, string maDonVi, int donViTinh)
        {
            ...
            List<TlCanBoPhuCap> listDataPhuCap = new List<TlCanBoPhuCap>();
            ...
            foreach (var cbo in listCanBoDelete)
            {
                ...
                dataRow[ExportColumnHeader.NGAY_TAI_NGU] = cbo.NgayTn.HasValue ? cbo.NgayTn.Value.ToString("MM/yy") : string.Empty;
                dataRow[ExportColumnHeader.PARENT] = cbo.Parent;
                var predicateDelete = PredicateBuilder.True<TlCanBoPhuCap>();
        ...
        public IEnumerable<TlBangLuongThang> FindAll()
        {
            return _tlBangLuongThangRepository.FindAll();
        }

        public DataTable ReportQtQuanSo(Expression<Func<TlQsChungTuChiTiet, bool>> predicate, List<TlDmDonVi> list)
        {
            ...
            result.Columns.Add(ExportColumnHeader.MA_DONVI);
            ...
            foreach (var donvi in list)
            {
                ...
                if (listDataDonVi == null) continue;
                DataRow dataRow = result.NewRow();
                dataRow[ExportColumnHeader.MA_DONVI] = donvi.MaDonVi;
            ...
            result.DefaultView.Sort = "MaDonVi asc";
            return result.DefaultView.ToTable();
        }

        public List<TlQsChungTuChiTiet> FindChungTuChiTiet(Expression<Func<TlQsChungTu, bool>> predicate)
        {
            var data = _tlQsChungTuRepository.FindAll(predicate).FirstOrDefault();
            List<TlQsChungTuChiTiet> list = new List<TlQsChungTuChiTiet>();
            if (data != null)
            {
        ...
        public List<TlQsChungTuChiTiet> FindChungTuChiTietSummary(Expression<Func<TlQsChungTu, bool>> predicate, List<String> listDonVi)
        {
            ...
            List<TlQsChungTuChiTiet> chungTuChiTietTongHop = new List<TlQsChungTuChiTiet>();
            foreach (var mucLuc in listMucLuc)
            {
                TlQsChungTuChiTiet model = new TlQsChungTuChiTiet();
        ...
        public DataTable ExportTongHopLuongTheoNgach(int thang, int nam, List<TlDmDonVi> listDonVi, string maCachTl, int donViTinh, bool isSummary, bool isReduceBHXH)
        {
            var lstDonViStr = listDonVi.Select(x => x.MaDonVi);
            var data = _tlBangLuongThangRepository.FindLuongNgachCanBo(thang, nam, string.Join(",", lstDonViStr), maCachTl, donViTinh, isSummary, isReduceBHXH);
            data.Columns.Add(ExportColumnHeader.IS_PARENT, typeof(bool));
        ...
        public DataTable ExportTongHopLuongTheoDonVi(int thang, int nam, List<TlDmDonVi> listDonVi, string maCachTl, int donViTinh, bool isReduceBHXH)
        {
            var lstDonViStr = listDonVi.Select(x => x.MaDonVi);
            var data = _tlBangLuongThangRepository.FindLuongDonViCanBo(thang, nam, string.Join(",", lstDonViStr), maCachTl, donViTinh, isReduceBHXH);
            data.Columns.Add(ExportColumnHeader.IS_PARENT, typeof(bool));
            data.Columns.Add("IsHeader", typeof(bool));
            DataRow firstRow = data.NewRow();
        ...
        public DataTable ExportTongHopLuongTheoNgachDonVi(int thang, int nam, List<TlDmDonVi> listDonVi, string maCachTl, int donViTinh, bool isReduceBHXH)
        {
            var lstDonViStr = listDonVi.Select(x => x.MaDonVi);
            var data = _tlBangLuongThangRepository.FindLuongNgachDonViCanBo(thang, nam, string.Join(",", lstDonViStr), maCachTl, donViTinh, isReduceBHXH);
            var dsNgach = new Dictionary<string, string>()
            {
                { "1", "Sĩ quan"},
                { "2", "QNCN"},
        ...
        public void BulkInsert(IEnumerable<TlBangLuongThang> entities)
        {
            _tlBangLuongThangRepository.BulkInsert(entities);
        }

        public List<TlRptTruyLinhChuyenCheDoQuery> ExportTruyLinhChuyenCheDo(Expression<Func<TlDmCanBo, bool>> predicate, string maDonVi, int thang, int nam, bool isOrderChucVu)
        {
        ...
        public DataTable ExportBaoCaoTienAn(Expression<Func<TlBangLuongThang, bool>> predicate, List<TlDmDonVi> listDonVi, int donViTinh)
        {
        ...
        public DataTable GetDataTienAn(DataTable data, string maDonVi, List<TlDmPhuCap> lstPhuCap)
        {
        ...
        public DataTable GetDataBangLuongPhuCapTongHopBienPhong(List<TlDmDonVi> lstDonVi, int thang, int nam)
        {
        ...
        public DataTable ExportBaoCaoTienAn(DataTable data, List<TlDmPhuCap> lstPhuCap)
        {
            data.Columns.Add(ExportColumnHeader.IS_PARENT, typeof(bool));
            DataTable rs = new DataTable();
            if (data != null && data.Rows.Count > 0)
        ...
        public Dictionary<string, object> ReportBangLuongThangDongData(List<TlBangLuongThangDongQuery> data, List<TlBangLuongThangDongQuery> lstHslCb, List<TlDmDonVi> lstDonVi, int page, int totalPage)
        {
        ...
        public DataTable ReportGiaiThichChiTietPhuCapKhac(List<TlDmDonVi> lstDonVi, List<TlDmPhuCap> listPhuCap, int nam, int thang, string maCachTl, int donViTinh, bool isOrderChucVu, bool isReducebackPay = false)
        {
            string maDonVi = string.Join(",", lstDonVi.Select(x => x.MaDonVi));
            string maPhuCap = string.Join(",", listPhuCap.Select(x => x.MaPhuCap).Distinct());
            return _tlBangLuongThangRepository.ReportGiaiThichChiTietPhuCapKhac(maDonVi, maPhuCap, nam, thang, maCachTl, donViTinh, isOrderChucVu, isReducebackPay);
        }

        public DataTable ReportGiaiThichChiTietPhuCapTruyLinhKhac(List<TlDmDonVi> lstDonVi, List<TlDmPhuCap> listPhuCap, int nam, int thang, string maCachTl, int donViTinh, bool isOrderChucVu)
        {
            string maDonVi = string.Join(",", lstDonVi.Select(x => x.MaDonVi));
            string maPhuCap = string.Join(",", listPhuCap.Select(x => x.MaPhuCap).Distinct());
        ...
        public DataTable ReportGiaiThichPhuCapTheoNgay(List<TlDmDonVi> lstDonVi, List<TlDmPhuCap> listPhuCap, int nam, int thang, string maCachTl, int donViTinh, bool isOrderChucVu)
        {
            string maDonVi = string.Join(",", lstDonVi.Select(x => x.MaDonVi));
            string maPhuCap = string.Join(",", listPhuCap.Select(x => x.MaPhuCap).Distinct());
        ...
        public DataTable ReportGiaiThichSoNgayPhuCapTheoNgay(List<TlDmDonVi> lstDonVi, List<TlDmPhuCap> listPhuCap, int nam, int thang, string maCachTl, int donViTinh, bool isOrderChucVu)
        {
            string maDonVi = string.Join(",", lstDonVi.Select(x => x.MaDonVi));
            string maPhuCap = string.Join(",", listPhuCap.Select(x => x.MaPhuCap).Distinct());
        ...
        public DataTable GetDataRaQuanXuatNgu(List<TlDmDonVi> listDonVi, int thang, int nam, int donViTinh)
        {
            string maDonVi = string.Join(",", listDonVi.Select(x => x.MaDonVi));
        ...
        public DataTable ReportChiTraNganHangThuNhapKhac(List<TlDmDonVi> listDonVi, int thang, int nam, bool isSummary, bool isOrderChucVu)
        {
            string maDonVi = string.Join(",", listDonVi.Select(x => x.MaDonVi));
        ...
        public TlBangLuongThang GetMonthlySalary(string maCanBo, string maPhuCap, int? thang, int? nam)
        {
            return _tlBangLuongThangRepository.GetMonthlySalary(maCanBo, maPhuCap, thang, nam);
        }

        public TlBangLuongThang GetLatestSalary(string maCanBo, int? thang, int? nam)
        {
            return _tlBangLuongThangRepository.GetLatestSalary(maCanBo, thang, nam);
        }

        public DataTable GetDataBangLuongThangTruBHXH(List<TlDmDonVi> listDonVi, int thang, int nam, bool isOrderChucVu, bool isGiaTriAm, bool isCheckedMaHuongLuong, bool isInCanBoMoi, bool isReduceBackPay = false)
        {
            string maDonVi = string.Join(",", listDonVi.Select(x => x.MaDonVi));
            return _tlBangLuongThangRepository.GetDataBangLuongThangTruBHXH(maDonVi, thang, nam, isOrderChucVu, isGiaTriAm, isCheckedMaHuongLuong, isInCanBoMoi, isReduceBackPay);
        }

        public DataTable ReportBangLuongThangTheoDonViTruBHXH(List<TlDmDonVi> listDonVi, int thang, int nam, bool isOrderChucVu, bool isGiaTriAm, bool isCheckedMaHuongLuong)
        {
            string maDonVi = string.Join(",", listDonVi.Select(x => x.MaDonVi));
        ...
        public IEnumerable<TlBangLuongThangQuery> GetDataInsertTruyThu(Guid idBangLuong, int thang, int nam, string maDonVi)
        {
            return _tlBangLuongThangRepository.GetDataInsertTruyThu(idBangLuong, thang, nam, maDonVi);
        }

        public int CleanupData()
        {
            return _tlBangLuongThangRepository.CleanupData();
        }
    }
}
