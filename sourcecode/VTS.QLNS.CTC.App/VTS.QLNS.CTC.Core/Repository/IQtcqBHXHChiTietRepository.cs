...
{
    public interface IQtcqBHXHChiTietRepository : IRepository<BhQtcqBHXHChiTiet>
    {
        ...
        IEnumerable<BhQtcqBHXHChiTietQuery> BaoCaoQuyetToanChiQuyBHXH(int iNamLamViec, string idMaDonVi, string sLNS, bool isTongHop, int iQuy, int donViTinh);
        ...
        List<BhQtcqGiaiThichTroCapTaiNanQuery> ExportDanhSachHuongTroCapTaiNanNNTheoKhoi(int yearOfWork, int donViTinh, int iQuy, string donVi);
        IEnumerable<BhBaoCaoQuyetToanChiQuyQuery> BaoCaoGiaiThichTroCapThaiSanFollowKhoi(int yearOfWork, string donVi, int iQuy, int donViTinh);
        List<BhQtcqGiaiThichTroCapHTPVXNTVTTQuery> ExportDanhSachHuongTroCapHTPVXNTVTTDetailXN(int yearOfWork, int donViTinh, int iQuy, string donVi);
        List<BhQtcqGiaiThichTroCapHTPVXNTVTTQuery> ExportDanhSachHuongTroCapHTPVXNTVTTKhoi(int yearOfWork, int donViTinh, int iQuy, string donVi);
        List<BhQtcqGiaiThichTroCapHTPVXNTVTTQuery> ExportDanhSachHuongTroCapHTPVXNTVTTKhoiDetailXN(int yearOfWork, int donViTinh, int iQuy, string donVi);
        IEnumerable<BhBaoCaoQuyetToanChiQuyQuery> BaoCaoGiaiThichTroCapOmDauKhoi(int yearOfWork, string donVi, string lNS_9010001_9010002, bool isTongHop, int iQuy, int donViTinh);
        ...
        IEnumerable<BhBaoCaoQuyetToanChiQuyQuery> BaoCaoGiaiThichTroCapThaiSanFollowKhoiNhomDT(int yearOfWork, string donVi, int iQuy, int donViTinh);
        ...
        List<BhQtcqGiaiThichTroCapHTPVXNTVTTQuery> ExportDanhSachHuongTroCapHTPVXNTVTTKhoiNhomDTDetail(int yearOfWork, int donViTinh, int iQuy, string donVi);
        List<BhQtcqGiaiThichTroCapHTPVXNTVTTQuery> ExportDanhSachHuongTroCapHTPVXNTVTTKhoiNhomDT(int yearOfWork, int donViTinh, int iQuy, string donVi);
    }
}
