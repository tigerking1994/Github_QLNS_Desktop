...
{
    public interface INsDtChungTuChiTietRepository : IRepository<NsDtChungTuChiTiet>
    {
        ...
        IEnumerable<NsDtChungTuChiTietQuery> FindDuToanTheoNganh(EstimationVoucherDetailCriteria searchCondition);
        ...
        IEnumerable<NsDtChungTuChiTiet> FindByListIdChungTu(IEnumerable<string> listIdChungTu);
        ...
        IEnumerable<ReportDuToanTongHopSoPhanBoQuery> GetDataReportTongHopSoPhanBo(int namLamViec, int namNganSach, int nguonNganSach, string lns,
            DateTime? ngayQuyetDinh, double donViTinh, int loaiDuToan, string sSoQuyetDinh);
        IEnumerable<ReportDuToanTongHopSoPhanBoQuery> GetDataReportTongHopSoPhanBoHienVat(int namLamViec, int namNganSach, int nguonNganSach,
            string lns, DateTime? ngayQuyetDinh, double donViTinh, int loaiDuToan, string sSoQuyetDinh);
        ...
        IEnumerable<NsDtChungTuCongKhaiQuery> GetDataBaoCaoDanhMucCongKhai02Clone(int iNamLamViec, int iNamNganSach, int iMaNguonNganSach, int iQuarterMonths, string sIdDanhMucCongKhai, int dvt, string sIdChungTu);
