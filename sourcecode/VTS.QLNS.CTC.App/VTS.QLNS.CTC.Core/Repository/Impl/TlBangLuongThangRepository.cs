...
{
    public class TlBangLuongThangRepository : Repository<TlBangLuongThang>, ITlBangLuongThangRepository
    {
        private readonly ApplicationDbContextFactory _contextFactory;

        public TlBangLuongThangRepository(ApplicationDbContextFactory contextFactory)
             : base(contextFactory)
        {
        ...
        public int DeleteByParentId(Guid parentId)
        {
            ...
            {
                ctx.TlBangLuongThangs.RemoveRange(ctx.TlBangLuongThangs.Where(x => x.Parent == parentId));
        ...
        public IEnumerable<TlBangLuongThang> FindByParentId(Guid parentId)
        {
            using (var ctx = _contextFactory.CreateDbContext())
            {
                return ctx.TlBangLuongThangs.Where(x => x.Parent == parentId).ToList();
            }
        }

        public DataTable ReportBangLuongThang(string maDonVi, int thang, int nam, bool isOrderChucVu, bool isGiaTriAm, bool isCheckedMaHuongLuong, bool isInCanBoMoi, bool isReduceBackPay = false)
        {
            using (var ctx = _contextFactory.CreateDbContext())
            {
                string sql = "dbo.sp_tl_rpt_bangthanhtoan_luongthang";
                if (isReduceBackPay)
                    sql = "dbo.sp_tl_rpt_bangthanhtoan_luongthang_truy_thu";
                var parameters = new[]
                {
        ...
        public IEnumerable<TlBangLuongThang> FindMaCanBo(string maCanBo)
        {
            using (var ctx = _contextFactory.CreateDbContext())
            {
                return ctx.TlBangLuongThangs.Where(x => x.MaCbo == maCanBo).ToList();
            }
        }

        public DataTable RptDSChiTraCaNhanNganHang(int nam, int thang, List<TlDmDonVi> tlDmDonVis, bool isReduceBHXH)
        {
            using (var ctx = _contextFactory.CreateDbContext())
            {
                ...
                cmd.Parameters.Add(new SqlParameter("@IsReduceBHXH", isReduceBHXH));
        ...
        public DataTable FindLuongNgachCanBo(int thang, int nam, string maDonVi, string maCachTL, int donViTinh, bool isSummary, bool isReduceBHXH)
        {
            using (var ctx = _contextFactory.CreateDbContext())
            {
                string sql = "sp_tl_rpt_tonghop_luong_theo_ngach";
                if (isReduceBHXH)
                    sql = "sp_tl_rpt_tonghop_luong_theo_ngach_tru_bhxh";
                SqlParameter[] parameters = new SqlParameter[]
                {
                    new SqlParameter("@thang", thang),
                    new SqlParameter("@nam", nam),
        ...
        public DataTable FindLuongDonViCanBo(int thang, int nam, string maDonVi, string maCachTL, int donViTinh, bool isReduceBHXH)
        {
            using (var ctx = _contextFactory.CreateDbContext())
            {
                string sql = "sp_tl_rpt_tonghop_luong_theo_don_vi";
                if (isReduceBHXH)
                    sql = "sp_tl_rpt_tonghop_luong_theo_don_vi_tru_bhxh";
                SqlParameter[] parameters = new SqlParameter[]
                {
                    new SqlParameter("@thang", thang),
                    new SqlParameter("@nam", nam),
        ...
        public DataTable FindLuongNgachDonViCanBo(int thang, int nam, string maDonVi, string maCachTL, int donViTinh, bool isReduceBHXH)
        {
            using (var ctx = _contextFactory.CreateDbContext())
            {
                string sql = "sp_tl_rpt_tonghop_luong_theo_ngach_don_vi";
                if (isReduceBHXH)
                    sql = "sp_tl_rpt_tonghop_luong_theo_ngach_don_vi_tru_bhxh";
                SqlParameter[] parameters = new SqlParameter[]
                {
                    new SqlParameter("@thang", thang),
                    new SqlParameter("@nam", nam),
        ...
        public DataTable GetDataReportDanhSachChiTraNganHang(string maDonVi, int nam, int thang, bool isReduceBHXH)
        {
            using (var ctx = _contextFactory.CreateDbContext())
            {
                ...
                var parameters = new[]
                {
                    ...
                    new SqlParameter("@Thang", thang),
                    new SqlParameter("@Nam", nam),
                    new SqlParameter("@IsReduceBHXH", isReduceBHXH)
                };
                return ctx.FromSqlCommand(sql, parameters);
            }
        }
        ...
        public DataTable ReportGiaiThichChiTietPhuCapKhac(string maDonVi, string maPhuCap, int nam, int thang, string maCachTl, int donViTinh, bool isOrderChucVu, bool isReducebackPay = false)
        {
            using (var ctx = _contextFactory.CreateDbContext())
            {
                string sql = "dbo.sp_tl_rpt_giaithich_chitiet_phucap_khac";
                if (isReducebackPay)
                    sql = "dbo.sp_tl_rpt_giaithich_chitiet_phucap_khac_truy_thu";
                var parameters = new[]
                {
                    new SqlParameter("@MaDonVi", maDonVi),
                    new SqlParameter("@Nam", nam),
        ...
        public TlBangLuongThang GetMonthlySalary(string maCanBo, string maPhuCap, int? thang, int? nam)
        {
            using (var ctx = _contextFactory.CreateDbContext())
            {
                return ctx.TlBangLuongThangs.FirstOrDefault(x => x.MaHieuCanBo == maCanBo && x.MaPhuCap == maPhuCap && x.Nam == nam && x.Thang == thang);
            }
        }
        ...
        public TlBangLuongThang GetLatestSalary(string maCanBo, int? thang, int? nam)
        {
            using (var ctx = _contextFactory.CreateDbContext())
            {
                ...
                return ctx.FromSqlRaw<TlBangLuongThang>(sql, parameters).FirstOrDefault();
            }
        }

        public DataTable GetDataBangLuongThangTruBHXH(string maDonVi, int thang, int nam, bool isOrderChucVu, bool isGiaTriAm, bool isCheckedMaHuongLuong, bool isInCanBoMoi, bool isReduceBackPay = false)
        {
            using (var ctx = _contextFactory.CreateDbContext())
            {
                string sql = "dbo.sp_tl_rpt_bangthanhtoan_luongthang_tru_bhxh";
                //if (isReduceBackPay)
                //    sql = "dbo.sp_tl_rpt_bangthanhtoan_luongthang_tru_bhxh_truy_thu";
                var parameters = new[]
                {
                    new SqlParameter("@MaDonVi", maDonVi),
                    new SqlParameter("@Thang", thang),
        ...
        public IEnumerable<TlBangLuongThangQuery> GetDataInsertTruyThu(Guid idBangLuong, int thang, int nam, string maDonVi)
        {
            using (var ctx = _contextFactory.CreateDbContext())
            {
                string sql = "EXECUTE dbo.sp_tl_get_data_canbo_truy_thu @Thang,@Nam,@MaDonVi,@iIdBangLuong";
                var parameters = new[]
                {
                    new SqlParameter("@MaDonVi", maDonVi),
                    new SqlParameter("@Thang", thang),
                    new SqlParameter("@Nam", nam),
                    new SqlParameter("@iIdBangLuong", idBangLuong),
                };
                return ctx.FromSqlRaw<TlBangLuongThangQuery>(sql, parameters);
            }
        }
        ...
        public int CleanupData()
        {
            using (var ctx = _contextFactory.CreateDbContext())
            {
                string sql = "EXECUTE sp_tl_clean_salary_data";
