...
{
    public partial class TlQtChungTuChiTietGiaiThich : EntityBase
    {
        public Guid IIdQtchungTu { get; set; }
        public int? IThang { get; set; }
        public int? INam { get; set; }
        public string IMaDonVi { get; set; }
        public double? FLuongSiQuanTru { get; set; }
        public double? FLuongSiQuan { get; set; }
        public double? FLuongQNCN { get; set; }
        public double? FLuongCNVC { get; set; }
        public double? FLuongHDLD { get; set; }
        public double? FPcSiQuan { get; set; }
        public double? FPcQNCN { get; set; }
        public double? FPcCNVC { get; set; }
        public double? FPcHDLD { get; set; }
        ...
        public int? IXuatNguSiQuan { get; set; }
        public int? IXuatNguQncn { get; set; }
        public int? IXuatNguHsqbs { get; set; }
        public int? IXuatNguKhac { get; set; }
        public int? IHuuSiQuan { get; set; }
        public int? IHuuQncn { get; set; }
        public int? IHuuHsqbs { get; set; }
        public int? IHuuKhac { get; set; }
        public int? IThoiViecSiQuan { get; set; }
        public int? IThoiViecQncn { get; set; }
        public int? IThoiViecHsqbs { get; set; }
        public int? IThoiViecKhac { get; set; }
    }
}
