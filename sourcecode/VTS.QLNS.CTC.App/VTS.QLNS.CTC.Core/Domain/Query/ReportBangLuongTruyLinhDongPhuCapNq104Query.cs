...
{
    public class ReportBangLuongTruyLinhDongPhuCapNq104Query
    {
        ...
        public List<GiaTriTruyLinhDongNq104> LstGiaTri { get; set; }
        public List<GiaTriTruyLinhDongNq104> LstGiaTriTotal { get; set; }
    }

    public class GiaTriTruyLinhDongNq104
    {
