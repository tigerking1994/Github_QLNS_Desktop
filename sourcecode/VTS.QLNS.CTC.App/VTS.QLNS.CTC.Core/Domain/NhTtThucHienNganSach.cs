...
{
    public partial class NhTtThucHienNganSach : EntityBase
    {
        ...
        public List<NhTtThucHienNganSachGiaiDoan> lstGiaiDoanTTCP { get; set; }
        public List<NhTtThucHienNganSachGiaiDoan> lstGiaiDoanKinhPhiDaGiaiNgan { get; set; }
        public List<NhTtThucHienNganSachGiaiDoan> lstGiaiDoanKinhPhiDuocCap { get; set; }
