...
{
    public partial class UpdateVersion_11335 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "BH_QTC_Nam_KCB_QuanYDonVi",
                columns: table => new
                {
                    ID_QTC_Nam_KCB_QuanYDonVi = table.Column<Guid>(nullable: false, defaultValueSql: "(newid())"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BH_QTC_Nam_KCB_QuanYDonVi", x => x.ID_QTC_Nam_KCB_QuanYDonVi)
                        .Annotation("SqlServer:Clustered", false);
                });

            migrationBuilder.CreateTable(
                name: "BH_QTC_Nam_KCB_QuanYDonVi_ChiTiet",
                columns: table => new
                {
                    ID_QTC_Nam_KCB_QuanYDonVi_ChiTiet = table.Column<Guid>(nullable: false, defaultValueSql: "(newid())"),
                    dNgaySua = table.Column<DateTime>(nullable: true),
                    dNgayTao = table.Column<DateTime>(nullable: true),
                    fTiLeThucHienTrenDuToan = table.Column<double>(nullable: true),
                    ...
                    iID_QTC_Nam_KCB_QuanYDonVi = table.Column<Guid>(nullable: false),
                    sNguoiSua = table.Column<string>(nullable: true),
                    sNguoiTao = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BH_QTC_Nam_KCB_QuanYDonVi_ChiTiet", x => x.ID_QTC_Nam_KCB_QuanYDonVi_ChiTiet)
                        .Annotation("SqlServer:Clustered", false);
                });
            migrationBuilder.RunSqlScript("AppData/_db/99_update_version_1.13.3.5_budget.sql");
            migrationBuilder.RunSqlScript("AppData/_db/99_update_version_1.13.3.5_salary.sql");
        }
