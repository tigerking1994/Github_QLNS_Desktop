...
namespace VTS.QLNS.CTC.Core.SqlBulkTools
{
    ...
    public class BulkInsert<T> : ITransaction
    {
        ...
        public Dictionary<string, object> _customColumnDefaultValueMappings { get; set; }
        ...
        public BulkInsert(IEnumerable<T> list, string tableName, string schema, HashSet<string> columns, HashSet<string> disableIndexList, bool disableAllIndexes, string sourceAlias,
            string targetAlias, Dictionary<string, string> customColumnMappings, Dictionary<string, object> customColumnDefaultValueMappings, int bulkCopyTimeout, bool bulkCopyEnableStreaming,
            int? bulkCopyNotifyAfter, int? bulkCopyBatchSize, SqlBulkCopyOptions sqlBulkCopyOptions, BulkOperations ext)
        {
            _customColumnDefaultValueMappings = customColumnDefaultValueMappings;
            _list = list;
            _tableName = tableName;
            _schema = schema;
            _columns = columns;
        ...
        void ITransaction.CommitTransaction(string connectionName, SqlCredential credentials, SqlConnection connection)
        {
            ...
            DataTable dt = _helper.ToDataTable(_list, _columns, _customColumnMappings, _customColumnDefaultValueMappings);
