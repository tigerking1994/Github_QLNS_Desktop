...
namespace VTS.QLNS.CTC.Core.SqlBulkTools
{
    ...
    public class ColumnSelect<T>
    {
        ...
        private Dictionary<string, object> CustomColumnDefaultValueMappings { get; set; }
            ...
            BulkOperations ext)
        {
            ...
            CustomColumnDefaultValueMappings = new Dictionary<string, object>();
        }
        ...
        /// <param name="columnName">Column name as represented in database</param>
        /// <returns></returns>
        public ColumnSelect<T> AddColumn(string columnName)
        {
        ...
        public ColumnSelect<T> CustomColumnMapping(string source, string destination)
        {
            CustomColumnMappings.Add(source, destination);
            return this;
        }

        public ColumnSelect<T> CustomColumnDefaultValueMapping(Dictionary<string, object> customColumnDefaultValueMappings)
        {
            CustomColumnDefaultValueMappings = customColumnDefaultValueMappings;
            return this;
        }
        ...
        {
            var bulk = new BulkInsert<T>(_list, _tableName, _schema, _columns, _disableIndexList, _disableAllIndexes, _sourceAlias, _targetAlias, 
                CustomColumnMappings, CustomColumnDefaultValueMappings, _bulkCopyTimeout, _bulkCopyEnableStreaming, _bulkCopyNotifyAfter, 
