...
{
    public class NhMstnKeHoachDatHangModel : ModelBase
    {
        ...
        [Validate("Mô tả chi tiết", Utility.Enum.DATA_TYPE.String, 4000, false)]
        public string SMoTa
        {
            get => _sMoTa;
        ...
        private string _sTenKeHoachTongThe;
        public string STenKeHoachTongThe
        {
            get => _sTenKeHoachTongThe;
            set => SetProperty(ref _sTenKeHoachTongThe, value);
        }

        private Guid? _iIdKHTTNhiemVuChiId;
        [Validate("Chương trình", Utility.Enum.DATA_TYPE.Guid, true)]
        ...
        [Validate("Tỉ giá", Utility.Enum.DATA_TYPE.Guid)]
