...
namespace VTS.QLNS.CTC.App.Model.Import
{
    ...
    public class ExpertiseImportModel : BindableBase
    {
        ...
        [ColumnAttribute("Sử dụng tồn kho", 9, ValidateType.IsNumber)]
        ...
        [ColumnAttribute("Chi đặc thù ngành phân cấp", 10, ValidateType.IsNumber)]
