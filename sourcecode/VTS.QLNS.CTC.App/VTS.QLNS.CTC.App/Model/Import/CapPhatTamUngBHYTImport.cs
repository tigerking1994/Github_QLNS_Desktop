...
namespace VTS.QLNS.CTC.App.Model.Import
{
    ...
    public class CapPhatTamUngBHYTImport : BindableBase
    {
        ...
        [ColumnAttribute("Tên cơ sở y tế", 2)]
        ...
        [ColumnAttribute("Mã cơ sở y tế", 1)]
        ...
        [ColumnAttribute("Quyết toán quý trước", 3, ValidateType.IsNumber)]
        ...
        [ColumnAttribute("Số đã cấp còn thừa quý trước chuyển sang", 4, ValidateType.IsNumber)]
        ...
        [ColumnAttribute("Dự kiến số cấp tạm ứng quý này", 5, ValidateType.IsNumber)]
        ...
        [ColumnAttribute("Số phải cấp tạm ứng quý này", 6, ValidateType.IsNumber)]
        ...
        [ColumnAttribute("Lũy kế đến cuối quý này", 7, ValidateType.IsNumber)]
        ...
        public bool IsHadData => !string.IsNullOrWhiteSpace(_iID_MaCoSoYTe);
    }
}
