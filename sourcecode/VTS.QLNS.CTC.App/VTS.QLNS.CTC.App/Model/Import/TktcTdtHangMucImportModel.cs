...
namespace VTS.QLNS.CTC.App.Model.Import
{
    ...
    public class TktcTdtHangMucImportModel : BindableBase
    {
        ...
        [ColumnAttribute("Giá trị phê duyệt (PDDA)", 4)]
        ...
        private string _fGiaTriPDTDT;
        [ColumnAttribute("Giá trị phê duyệt (TKTC TDT)", 5)]
        public string FGiaTriPDTDT
        {
            get => _fGiaTriPDTDT;
            set
            {
                SetProperty(ref _fGiaTriPDTDT, value);
            }
        }
