...
{
    public class TlDmPhuCapNq104Model : ModelBase
    {
        ...
        [TypeOfDialogAttribute(typeof(TlDmPhuCapNq104Model), typeof(TlDmPhuCapNq104), typeof(TlDmPhuCapNq104Service), typeof(ITlDmPhuCapNq104Service))]
        ...
        private bool? _isTinhTheoSoCongChuan;
        [DisplayName("Tính theo số công chuẩn")]
        [ColumnType(ColumnType.Checkbox)]
        public bool? IsTinhTheoSoCongChuan
        {
            get => _isTinhTheoSoCongChuan;
            set => SetProperty(ref _isTinhTheoSoCongChuan, value);
        }
    }
}
