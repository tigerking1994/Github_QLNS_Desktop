...
{
    public class RptQuanSoRaQuan
    {
        public List<ReportQuanSoRaQuanQuery> Items { get; set; }
        public string Cap1 { get; set; }
        public string Cap2 { get; set; }
        public string TieuDe { get; set; }
        public string TieuDe2 { get; set; }
        public string TieuDe3 { get; set; }
        public string TenPhuLuc { get; set; }
        public string Nam { get; set; }
        public string TenDonVi { get; set; }
        public string Ngay { get; set; }
        public string DiaDiem { get; set; }
        public double? HuuThangTruoc { get; set; }
        public double? PhucVienThangTruoc { get; set; }
        public double? XuatNguThangTruoc { get; set; }
        public double? ThoiViecThangTruoc { get; set; }
