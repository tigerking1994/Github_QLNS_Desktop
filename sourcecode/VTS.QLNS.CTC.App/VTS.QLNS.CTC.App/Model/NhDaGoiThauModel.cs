...
{
    public class NhDaGoiThauModel : ModelBase
    {
        ...
        [ValidateAttribute("hình thức chọn nhà thầu", Utility.Enum.DATA_TYPE.Guid, true)]
        ...
        [ValidateAttribute("phương thức chọn nhà thầu", Utility.Enum.DATA_TYPE.Guid, true)]
        ...
        [ValidateAttribute("loại hợp đồng", Utility.Enum.DATA_TYPE.Guid, true)]
      ...
      //  [ValidateAttribute("Chương trình", Utility.Enum.DATA_TYPE.Guid, true)]
       ...
       [ValidateAttribute("Số HSTKKT TDT", Utility.Enum.DATA_TYPE.Guid, true)]
        ...
        public double? _fGiaTrungThauVND;
        public double? FGiaTrungThauVND
        {
            get => _fGiaTrungThauVND;
            set => SetProperty(ref _fGiaTrungThauVND, value);
        }
        public double? _fGiaTrungThauUSD;
        public double? FGiaTrungThauUSD
        {
            get => _fGiaTrungThauUSD;
            set => SetProperty(ref _fGiaTrungThauUSD, value);
        }

        public double? _fGiaTrungThauEUR;
        public double? FGiaTrungThauEUR
        {
            get => _fGiaTrungThauEUR;
            set => SetProperty(ref _fGiaTrungThauEUR, value);
        }
