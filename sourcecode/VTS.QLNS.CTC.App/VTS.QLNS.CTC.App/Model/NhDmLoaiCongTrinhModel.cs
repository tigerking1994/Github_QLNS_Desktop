...
{
    public class NhDmLoaiCongTrinhModel : ModelBase
    {
        public Guid? IIdParent { get; set; }

        private string _sMaLoaiCongTrinh;
        [Validate("Mã loại công trình", DATA_TYPE.String, 50, true)]
        ...
        [Validate("Tên viết tắt", DATA_TYPE.String, 100)]
        ...
        [Validate("Tên loại công trình", DATA_TYPE.String, 300, true)]
        ...
        [TypeOfDialogAttribute(typeof(NhDmLoaiCongTrinhModel), typeof(NhDmLoaiCongTrinh), typeof(NhDmLoaiCongTrinhService), typeof(INhDmLoaiCongTrinhService))]
        ...
        private NhDmLoaiCongTrinhModel _parent;
        [JsonIgnore]
        public NhDmLoaiCongTrinhModel Parent
        {
            get => _parent;
            set
            {
        ...
        [JsonIgnore]
        public virtual ICollection<NhDmLoaiCongTrinhModel> Children { get; set; }
    }
}
