...
{
    public class CadresModel : ModelBase
    {
    ...
    public class CadresComparer : IEqualityComparer<CadresModel>
    {
        public bool Equals(CadresModel x, CadresModel y)
        {
            return x.MaCanBo == y.MaCanBo;
        }

        public int GetHashCode(CadresModel obj)
        {
