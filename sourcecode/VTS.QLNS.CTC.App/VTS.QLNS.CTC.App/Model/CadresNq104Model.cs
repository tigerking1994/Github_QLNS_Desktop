...
{
    public class CadresNq104Model : ModelBase
    {
        ...
        private int? _thoiHanTangCvd;
        public int? ThoiHanTangCvd
        {
            get => _thoiHanTangCvd;
            set => SetProperty(ref _thoiHanTangCvd, value);
        }
        ...
        private decimal? _tienLuongKeHoach;
        public decimal? TienLuongKeHoach
        {
            get => _tienLuongKeHoach;
            set => SetProperty(ref _tienLuongKeHoach, value);
        }
    ...
    public class CadresNq104Comparer : IEqualityComparer<CadresNq104Model>
    {
        public bool Equals(CadresNq104Model x, CadresNq104Model y)
        {
            return x.MaCanBo == y.MaCanBo;
        }

        public int GetHashCode(CadresNq104Model obj)
        {
