...
{
    public class BhQtcQuyKinhPhiQuanLyModel : ModelBase
    {
        ...
        private int? _iQuyChungTu;

        public int? IQuyChungTu
        {
            get => _iQuyChungTu;
            set => SetProperty(ref _iQuyChungTu, value);
        }
        private int? _iNamChungTu;

        public int? INamChungTu
        {
            get => _iNamChungTu;
            set => SetProperty(ref _iNamChungTu, value);
        }
        ...
        private double? _fTongTienDuToanDuocGiao;

        public double? FTongTienDuToanDuocGiao
        {
            get => _fTongTienDuToanDuocGiao;
            set => SetProperty(ref _fTongTienDuToanDuocGiao, value);
        }
        ...
        private double? _fTongTienLuyKeDenCuoiQuy;
        public double? FTongTienLuyKeDenCuoiQuy
        {
            get => _fTongTienLuyKeDenCuoiQuy;
            set => SetProperty(ref _fTongTienLuyKeDenCuoiQuy, value);
        }
        ...
        public string SMaTen => IID_MaDonVi + " - " + STenDonVi;
