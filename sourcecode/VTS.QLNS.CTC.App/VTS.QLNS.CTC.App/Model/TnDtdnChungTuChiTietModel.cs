...
{
    public class TnDtdnChungTuChiTietModel : DetailModelBase
    {
        private Guid _id;
        public Guid Id
        {
        ...
        public double _fDuToanNamNay;
        public double FDuToanNamNay
        {
            get => _fDuToanNamNay;
            set
            {
        ...
        public double _fUocThucHienNamNay;
        public double FUocThucHienNamNay
        {
        ...
        public double _fDuToanNamKeHoach;
        public double FDuToanNamKeHoach
        {
        ...
        public bool IsHasData => FDuToanNamKeHoach != 0 || FDuToanNamNay != 0 || FThucThuNamTruoc != 0 || FUocThucHienNamNay != 0;
        ...
        public bool IsDynamic => !LstGiaTri.IsEmpty() && LstGiaTri.Any(x => x.FVal != 0);
    ...
    public class TnDtdnChungTuChiTietDynamicModel :DetailModelBase
