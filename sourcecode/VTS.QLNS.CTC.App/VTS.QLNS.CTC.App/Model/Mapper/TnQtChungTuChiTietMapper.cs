...
{
    class TnQtChungTuChiTietMapper : Profile
    {
        public TnQtChungTuChiTietMapper()
        {
            CreateMap<TnQtChungTuChiTiet, TnQtChungTuChiTietModel>().ForMember(entity => entity.IsHangCha, model => model.MapFrom(z => z.BLaHangCha));
            CreateMap<TnQtChungTuChiTietModel, TnQtChungTuChiTiet>().ForMember(entity => entity.BLaHangCha, model => model.MapFrom(z => z.IsHangCha));
            CreateMap<TnQtChungTuChiTietReportQuery, TnQtChungTuChiTietModel>().ForMember(entity => entity.IsHangCha, model => model.MapFrom(z => z.BLaHangCha));
            CreateMap<RealRevenueExpenditureDetailImportModel, TnQtChungTuChiTiet>()
            ...
            CreateMap<TnQtChungTuChiTietQuery, TnQtChungTuChiTietModel>()
                .ForMember(entity => entity.IsHangCha, model => model.MapFrom(x => x.BLaHangCha));
        }
    }
}
