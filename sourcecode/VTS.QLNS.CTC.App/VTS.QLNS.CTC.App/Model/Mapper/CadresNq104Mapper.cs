...
{
    public class CadresNq104Mapper : Profile
    {
        public CadresNq104Mapper()
        {
            CreateMap<CadresNq104Model, TlDmCanBoNq104>();
            CreateMap<TlDmCanBoNq104, CadresNq104Model>()
                ...
                .ForMember(entity => entity.TlCanBoPhuCapNq104s, model => model.MapFrom(item => item.TlCanBoPhuCapsNq104.Select(x => new TlCanBoPhuCapNq104Model
                {
                    Id = x.Id,
                    MaCbo = x.MaCbo,
                    MaPhuCap = x.MaPhuCap,
            ...
            CreateMap<CadresNq104Model, TlGtTaiChinhModel>();
            CreateMap<TlGtTaiChinhModel, CadresNq104Model>();
            CreateMap<CadresNq104Model, TlDmCanBoKeHoachNq104Model>().ReverseMap();
            CreateMap<TlDmCanBoNq104Query, CadresNq104Model>()
            ...
            CreateMap<TlDmCanBoNq104Query, TlDmCanBoNq104>()
                .ForMember(e => e.MaCanBo, m => m.MapFrom(i => i.Ma_CanBo))
                .ForMember(e => e.TenCanBo, m => m.MapFrom(i => i.Ten_CanBo))
                .ForMember(e => e.DiaChi, m => m.MapFrom(i => i.Dia_Chi))
                .ForMember(e => e.MaCv, m => m.MapFrom(i => i.Ma_CV))
                ...
                .ForMember(e => e.bKhongTinhNTN, m => m.MapFrom(i => i.bKhongTinhNTN))
                .ForMember(e => e.BTinhBHXH, m => m.MapFrom(i => i.BTinhBHXH));
            CreateMap<TlDanhSachCanBoQuery, CadresNq104Model>()
                .ForMember(e => e.MaCanBo, m => m.MapFrom(i => i.Ma_CanBo))
                .ForMember(e => e.TenCanBo, m => m.MapFrom(i => i.Ten_CanBo))
                .ForMember(e => e.DiaChi, m => m.MapFrom(i => i.Dia_Chi))
                .ForMember(e => e.MaCv, m => m.MapFrom(i => i.Ma_CV))
