...
{
    public class NhDaGoiThauDetailChiPhiModel : BindableBase
    {
        ...
        public int? IIdNguonVonIdInt { get; set; } // Vì không thể sửa toàn bộ IDnguonVon từ Guid -> Int nên tạo biến mới
