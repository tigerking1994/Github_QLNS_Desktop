...
VALUES (NEWID(), 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, N'rptNS_Plan_DuToan_NganSach_ChiTiet_DonVi_NSSD', NULL, N'rptNS_Plan_DuToan_NganSach_ChiTiet_DonVi_NSSD', NULL, NULL, NULL, NULL, NULL, N'LAP_DU_TOAN_NGAN_SACH', NULL, N'Báo cáo dự toán ngân sách - Các nội dung thực hiện định mức thí điểm', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, N'1', N'BÁO CÁO CHI TIẾT DỰ TOÁN NGÂN SÁCH NHÀ NƯỚC CHI THƯỜNG XUYÊN CHO QUỐC PHÒNG ĐỐI VỚI NỘI DUNG CHI THỰC HIỆN ĐỊNH MỨC THÍ ĐIỂM NĂM 2024', N'1', N'(Nội dung ngân sách chi nghiệp vụ ngành)', N'.../QĐ-BQP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL)
GO
IF NOT EXISTS (SELECT * FROM [dbo].[DM_ChuKy] WHERE Id_Type = 'rptNS_Plan_DuToan_NganSach_ChiTiet_DonVi_NSDT')
INSERT [dbo].[DM_ChuKy] ([Id], [bDanhSach], [ChucDanh1], [ChucDanh1_MoTa], [ChucDanh2], [ChucDanh2_MoTa], [ChucDanh3], [ChucDanh3_MoTa], [ChucDanh4], [ChucDanh4_MoTa], [ChucDanh5], [ChucDanh5_MoTa], [ChucDanh6], [ChucDanh6_MoTa], [DateCreated], [DateModified], [INamLamViec], [iTrangThai], [Id_Code], [Id_Old_Type], [Id_Type], [KyHieu], [Log], [MoTa], [sKinhGuiCQTTBQP], [sKinhGuiKBNN], [sLoai], [Tag], [Ten], [Ten1], [Ten1_MoTa], [Ten2], [Ten2_MoTa], [Ten3], [Ten3_MoTa], [Ten4], [Ten4_MoTa], [Ten5], [Ten5_MoTa], [Ten6], [Ten6_MoTa], [ThuaLenh1], [ThuaLenh1_MoTa], [ThuaLenh2], [ThuaLenh2_MoTa], [ThuaLenh3], [ThuaLenh3_MoTa], [ThuaLenh4], [ThuaLenh4_MoTa], [ThuaLenh5], [ThuaLenh5_MoTa], [ThuaLenh6], [ThuaLenh6_MoTa], [TieuDe1], [TieuDe1_MoTa], [TieuDe2], [TieuDe2_MoTa], [TieuDe3_MoTa], [UserCreator], [UserModifier], [LoaiDVBanHanh1], [LoaiDVBanHanh2], [TenDVBanHanh1], [TenDVBanHanh2], [ThuaUyQuyen1], [ThuaUyQuyen1_MoTa], [ThuaUyQuyen2], [ThuaUyQuyen2_MoTa], [ThuaUyQuyen3], [ThuaUyQuyen3_MoTa]) 
VALUES (NEWID(), 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, N'rptNS_Plan_DuToan_NganSach_ChiTiet_DonVi_NSDT', NULL, N'rptNS_Plan_DuToan_NganSach_ChiTiet_DonVi_NSDT', NULL, NULL, NULL, NULL, NULL, N'LAP_DU_TOAN_NGAN_SACH', NULL, N'Báo cáo dự toán ngân sách - Các nội dung thực hiện định mức thí điểm', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, N'1', N'BÁO CÁO CHI TIẾT DỰ TOÁN NGÂN SÁCH NHÀ NƯỚC CHI THƯỜNG XUYÊN CHO QUỐC PHÒNG ĐỐI VỚI NỘI DUNG CHI THỰC HIỆN ĐỊNH MỨC THÍ ĐIỂM NĂM 2024', N'1', N'(Nội dung chi mua hàng cấp hiện vật)', N'.../QĐ-BQP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL)
GO
/****** Object:  StoredProcedure [dbo].[sp_skt_get_donvi_solieu_chitiet_all_loai]    Script Date: 11/7/2024 5:41:41 PM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[sp_ns_rpt_dtdn_du_toan_ngan_sach_nsdtn_excel]    Script Date: 11/7/2024 5:41:41 PM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[sp_ns_rpt_dtdn_du_toan_ngan_sach_nsdtn]    Script Date: 11/7/2024 5:41:41 PM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[sp_ns_rpt_dtdn_du_toan_ngan_sach_excel]    Script Date: 11/7/2024 5:41:41 PM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[sp_ns_rpt_dtdn_du_toan_ngan_sach_donvingang_nsdtn]    Script Date: 11/7/2024 5:41:41 PM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[sp_ns_rpt_dtdn_du_toan_ngan_sach_donvi_ngang]    Script Date: 11/7/2024 5:41:41 PM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[sp_ns_rpt_dtdn_du_toan_ngan_sach]    Script Date: 11/7/2024 5:41:41 PM ******/
...
BEGIN
	...
	select
		...
		(sum(isnull(ctct.fTuChi, 0)))/@DVT fMucTienPhanBo,
		0 fTuChi
	...
	where ct.iNamLamViec = @NamLamViec
		...
		and (ct.iID_MaNguonNganSach = @NguonNganSach or @NguonNganSach = 0)
	group by ml.iID_MLSKT, ml.iID_MLSKTCha, ml.bHangCha, ml.sM, ml.sSKT_KyHieu, ml.sMoTa
	) tmp
...
BEGIN
	...
	--Ban than
	select temp.* into #tbl_banthan from
		(select
		mlns.iID_MLNS IIDMLNS,
		mlns.iID_MLNS_Cha IIDMLNSCha,
		null IIDMLSKT,
		...
		where ct.iNamLamViec = @NamLamViec
			...
			and (ct.iID_MaNguonNganSach = @NguonNganSach or @NguonNganSach = 0)
		group by ml.iID_MLSKT, ml.iID_MLSKTCha, ml.bHangCha, ml.sM, ml.sSKT_KyHieu, ml.sMoTa) temp
...
BEGIN
	...
	select temp.* into #tbl_banthan from
		...
		ctct.sMoTa,
		0 fMucTienPhanBo,
		(sum(isnull(ctct.fHangNhap, 0)))/@DVT FHangNhapBanThan,
		(sum(isnull(ctct.fHangMua, 0)))/@DVT FHangMuaBanThan
		from NS_DTDauNam_ChungTuChiTiet ctct
		join NS_DTDauNam_ChungTu ct on ctct.iID_CTDTDauNam = ct.iID_CTDTDauNam
		join #mlns_skt ml on ctct.sXauNoiMa = ml.sNS_XauNoiMa
		left join NS_MucLucNganSach mlns on ctct.sXauNoiMa = mlns.sXauNoiMa and mlns.iNamLamViec = @NamLamViec and mlns.iTrangThai = 1
		...
		select
			...
			(sum(isnull(ctct.fMuaHangCapHienVat, 0)))/@DVT fMucTienPhanBo,
			0 FHangNhapBanThan,
			0 FHangMuaBanThan
		from NS_SKT_ChungTuChiTiet ctct
		join NS_SKT_ChungTu ct on ct.iId_CTSoKiemTra = ct.iId_CTSoKiemTra
...
BEGIN
	...
	where ct.iNamLamViec = @NamLamViec
		...
		and ctct.iID_MaDonVi not in (SELECT * FROM f_split(@DonViBanThan))
		and (ct.iID_MaNguonNganSach = @NguonNganSach or @NguonNganSach = 0)
	group by ml.iID_MLSKT, ml.iID_MLSKTCha, ml.bHangCha, ml.sM, ml.sSKT_KyHieu, ml.sMoTa, ctct.iID_MaDonVi) temp
		   ...
		   AND (fTuChi <> 0
			...
			SELECT DISTINCT chitiet.iID_MaDonVi
			 ...
			 WHERE chitiet.iNamLamViec = @YearOfWork
			   AND chitiet.iNamNganSach = @YearOfBudget
			   AND chitiet.iID_MaNguonNganSach = @BudgetOfSource
			   AND chitiet.iLoaiChungTu = @ILoaiChungTu
			   AND chitiet.iLoai = 4
