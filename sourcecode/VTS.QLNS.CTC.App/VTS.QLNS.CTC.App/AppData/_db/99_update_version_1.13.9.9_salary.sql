/****** Object:  StoredProcedure [dbo].[sp_tl_rpt_quyettoan_nam_thue_tncn]    Script Date: 2/16/2024 4:04:39 PM ******/
  ...
  (SELECT MaDonVi,
   ...
   FROM
     (SELECT canBo.MaDonVi,
      ...
      INNER JOIN ThongTinCanBo canBo ON bangLuong.MaHieuCanBo = canBo.MaHieuCanBo) x PIVOT (SUM(GiaTri)
