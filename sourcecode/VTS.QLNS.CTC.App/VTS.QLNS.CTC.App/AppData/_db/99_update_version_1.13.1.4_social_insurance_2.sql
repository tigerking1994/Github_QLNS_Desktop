/****** Object:  StoredProcedure [dbo].[sp_dt_dieuchinh_get_lns]    Script Date: 9/5/2023 8:01:02 AM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[sp_cp_rpt_thongtri_tonghop]    Script Date: 9/5/2023 8:01:02 AM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[sp_cp_rpt_kehoach_bh]    Script Date: 9/5/2023 8:01:02 AM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[sp_cp_lns_rpt_thongtri_lns_bh]    Script Date: 9/5/2023 8:01:02 AM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[sp_cp_get_donvi_report_kehoach_bh]    Script Date: 9/5/2023 8:01:02 AM ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[sp_cp_get_donvi_report_kehoach_bh]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[sp_cp_get_donvi_report_kehoach_bh]
GO
/****** Object:  StoredProcedure [dbo].[sp_cp_get_donvi_bh]    Script Date: 9/5/2023 8:01:02 AM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[sp_cp_chungtu_index_bh]    Script Date: 9/5/2023 8:01:02 AM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[sp_cp_chungtu_chi_tiet_tonghop]    Script Date: 9/5/2023 8:01:02 AM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[sp_cp_chungtu_chi_tiet]    Script Date: 9/5/2023 8:01:02 AM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[sp_cp_chungtu_chi_tiet]    Script Date: 9/5/2023 8:01:03 AM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[sp_cp_chungtu_chi_tiet_tonghop]    Script Date: 9/5/2023 8:01:03 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[sp_cp_chungtu_index_bh]    Script Date: 9/5/2023 8:01:03 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[sp_cp_get_donvi_bh]    Script Date: 9/5/2023 8:01:03 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
;
GO
/****** Object:  StoredProcedure [dbo].[sp_cp_get_donvi_report_kehoach_bh]    Script Date: 9/5/2023 8:01:03 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- Create date: <Create Date,,>
-- Description:	<Description,,>
-- Lay don vi cua chung tu cap phat chi tiet cho report ke hoach
-- =============================================
Create PROCEDURE [dbo].[sp_cp_get_donvi_report_kehoach_bh]
	@YearOfWork int,
	@IdMaDonVi nvarchar(100),
	@iQuy int
AS
BEGIN
	SELECT dv.* 
	...
	(
		...
		FROM BH_CP_ChungTu_ChiTiet 
		WHERE
			iID_CP_ChungTu IN (SELECT iID_CP_ChungTu 
										FROM BH_CP_ChungTu
										WHERE iQuy=@iQuy
								)
	) ctct
...
;
GO
/****** Object:  StoredProcedure [dbo].[sp_cp_lns_rpt_thongtri_lns_bh]    Script Date: 9/5/2023 8:01:03 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[sp_cp_rpt_kehoach_bh]    Script Date: 9/5/2023 8:01:03 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[sp_cp_rpt_thongtri_tonghop]    Script Date: 9/5/2023 8:01:03 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[sp_dt_dieuchinh_get_lns]    Script Date: 9/5/2023 8:01:03 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
