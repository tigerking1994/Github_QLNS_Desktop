/****** Object:  StoredProcedure [dbo].[sp_rpt_bh_thamdinhquyettoan_chitiet]    Script Date: 21/12/2023 12:05:02 PM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[sp_bh_thamdinhquyettoan_chitiet]    Script Date: 21/12/2023 12:05:02 PM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[sp_bh_thamdinhquyettoan]    Script Date: 21/12/2023 12:05:02 PM ******/
...
BEGIN
	...
	SELECT 
		...
		dmtdqp.iNamLamViec,
		dmtdqp.sNguoiTao, dmtdqp.sNguoiSua,
		SUM(ISNULL(ctct.fSoBaoCao, temp.fSoBaoCao)) fSoBaoCao,
		SUM(ctct.fSoThamDinh) fSoThamDinh,
		SUM(ctct.fQuanNhan) fQuanNhan,
		SUM(ctct.fCNVLDHD) fCNVLDHD
	FROM #dmtdqt dmtdqp
