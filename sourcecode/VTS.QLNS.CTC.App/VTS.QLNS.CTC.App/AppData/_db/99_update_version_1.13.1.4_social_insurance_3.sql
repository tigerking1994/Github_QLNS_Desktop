/****** Object:  StoredProcedure [dbo].[sp_bh_export_kehoachcaptamung_kcbbhyt]    Script Date: 8/29/2023 9:39:53 AM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[sp_bh_dt_danhsach_cptubhyt_chitiet]    Script Date: 8/29/2023 9:39:53 AM ******/
...
begin
	...
	select 
		...
		left join (
					select sum(ct.fSoCapBoSung) as fSoCapBoSung, sum(ct.fDaCapUng) as fDaCapUng,  iID_MLNS, iID_MaCoSoYTe, iQuy
					...
					group by iID_MLNS, iID_MaCoSoYTe, iQuy) as cp_bs on cp_bs.iID_MaCoSoYTe = ct.iID_MaCoSoYTe and ct.iID_MLNS = cp_bs.iID_MLNS
