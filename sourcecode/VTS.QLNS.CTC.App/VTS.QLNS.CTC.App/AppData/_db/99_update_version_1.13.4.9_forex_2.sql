/****** Object:  StoredProcedure [dbo].[sp_nh_goithau_trongnuoc_index]    Script Date: 11/15/2023 10:02:50 AM ******/
...
AS
BEGIN
	--DungNV update 15/11 lấy dữ liệu theo gói thầu ko lấy theo KHLCNT vì gói thầu đã lưu đủ dữ liệu rồi
	Select DISTINCT
		...
		goiThau.iID_DuToanID  as IIdDuToanId,
		...
		goiThau.iID_DonViQuanLyID as IID_DonViQuanLyID,
		goiThau.iID_KHTT_NhiemVuChiID  as IID_KHTT_NhiemVuChiID,
	...
	left join DonVi -- on (LCNhaThau.iID_DonViQuanLyID = DonVi.iID_DonVi AND goiThau.iCheckLuong is null) OR (goiThau.iID_DonViQuanLyID = DonVi.iID_DonVi  AND goiThau.iCheckLuong = 1)
		ON goiThau.iID_DonViQuanLyID = DonVi.iID_DonVi
	...
	left join NH_KHTongThe_NhiemVuChi khttnvc 
		...
		ON goiThau.iID_KHTT_NhiemVuChiID = khttnvc.ID 
