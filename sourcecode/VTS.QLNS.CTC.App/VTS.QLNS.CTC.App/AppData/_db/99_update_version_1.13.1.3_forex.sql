/****** Object:  StoredProcedure [dbo].[sp_insert_NH_TH_NguonNgoaiHoi_tang]    Script Date: 8/24/2023 8:35:19 AM ******/
...
BEGIN
	...
	BEGIN 
		...
		BEGIN
			...
			SELECT iID_DuAnID, iID_KHTT_NhiemVuChiID, iID_HopDongId, iID_DonVi, iID_MaDonViQuanLy, iCoQuanThanhToan, dNgayDeNghi, iNamKeHoach, iID_ChungTu,
							sMaDich, tbl.sMaNguon, sMaNguonCha, fGiaTriUsd, fGiaTriVnd, 1, 2, '300',iID_MucLucNganSach,iQuyKeHoach												
	...
	BEGIN
		...
		SELECT tbl.iID_DuAnID, ktt.ID, tbl.iID_HopDongId, tbl.iID_DonVi, tbl.iID_MaDonVi, tbl.dNgayDeNghi, tbl.iNamKeHoach, tbl.iQuyKeHoach, tbl.ID,
		...
		SELECT tbl.iID_DuAnID, ktt.ID, tbl.iID_HopDongId, tbl.iID_DonVi, tbl.iID_MaDonVi, tbl.dNgayDeNghi,
			...
			INNER JOIN(
				SELECT Id, iID_QuyetToanNienDoID, iID_KHTT_NhiemVuChiID, iID_DuAnID, iID_HopDongId, iID_MucLucNganSachID, dt.fGiaTri as fGiaTriUSD, 0 as fGiaTriVND,
						(CASE colName WHEN 'fQTKinhPhiDuyetCacNamTruoc_USD' THEN '301' 
									  ...
									  WHEN 'fThuaNopNSNN_USD' THEN '306'
									  WHEN 'fLuyKeKinhPhiDuocCap_USD' THEN '307'
									  WHEN 'fLuyKeKinhPhiDaGiaiNganTrongNamNay_USD' THEN '308'
									  WHEN 'fLuyKeKinhPhiDaGiaiNganKhoiDauDenHetNamNay_USD' THEN '309'
									  WHEN 'fLuyKeSoDuTamUngKinhPhiKhoiDauDenHetNamNay_USD' THEN '310'
									  WHEN 'fLuyKeSoDuTamUngCheDoKhoiDauDenHetNamNay_USD' THEN '000'
									  END) as sMaNguon				
				From
				( SELECT Id, iID_QuyetToanNienDoID, iID_KHTT_NhiemVuChiID, iID_DuAnID, iID_HopDongId, iID_MucLucNganSachID,
					...
					UNPIVOT
				(fGiaTri FOR colName IN (fQTKinhPhiDuyetCacNamTruoc_USD, fQTKinhPhiDuocCap_NamTruocChuyenSang_USD, fQTKinhPhiDuocCap_NamNay_USD
				, fDeNghiQTNamNay_USD, fDeNghiChuyenNamSau_USD, fThuaNopNSNN_USD, fLuyKeKinhPhiDuocCap_USD, fLuyKeKinhPhiDaGiaiNganTrongNamNay_USD,
				fLuyKeKinhPhiDaGiaiNganKhoiDauDenHetNamNay_USD, fLuyKeSoDuTamUngKinhPhiKhoiDauDenHetNamNay_USD, fLuyKeSoDuTamUngCheDoKhoiDauDenHetNamNay_USD)) as dt
