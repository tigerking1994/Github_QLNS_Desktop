/****** Object:  StoredProcedure [dbo].[sp_dt_danhsach_chungtu_chitiet_luyke]    Script Date: 9/4/2024 8:55:49 AM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[sp_dt_danhsach_chungtu_chitiet]    Script Date: 9/4/2024 8:55:49 AM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[sp_dt_chungtu_chitiet]    Script Date: 9/4/2024 8:55:49 AM ******/
...
BEGIN
  ...
  JOIN NguoiDung_DonVi ON DonVi.iID_MaDonVi = NguoiDung_DonVi.iID_MaDonVi  
	...
	SELECT 
		...
		ISNULL(p.fRutKBNN, 0) AS fRutKBNN,
	...
	FROM (SELECT * FROM #tblRowChiTiet WHERE fTonKho <> 0 OR fTuChi <> 0 OR fRutKBNN <> 0 OR fHienVat <> 0 OR fHangNhap <> 0 OR fHangMua <> 0 OR fPhanCap <> 0 OR fDuPhong <> 0) ct
	GROUP BY iID_MLNS, sSoQuyetDinh, idSoQuyetDinh
	...
	SELECT 
		...
		npb.fRutKBNN - ISNULL(rct.fRutKBNN, 0) AS fRutKBNN,
...
BEGIN
	...
	tblRowConLai AS (
		SELECT 
		    ...
		    npb.fRutKBNN - rct.fRutKBNN AS fRutKBNN,
