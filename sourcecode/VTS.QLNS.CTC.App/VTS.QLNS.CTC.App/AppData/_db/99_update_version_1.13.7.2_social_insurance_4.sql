/****** Object:  StoredProcedure [dbo].[sp_rpt_qtc_nqlkp_phucluc_bh]    Script Date: 12/25/2023 6:28:30 PM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[sp_rpt_qtc_nqlkp_kehoach_bh]    Script Date: 12/25/2023 6:28:30 PM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[sp_qtc_qkpql_create_data_summary_bh]    Script Date: 12/25/2023 6:28:30 PM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[sp_qtc_nkpql_create_data_summary_bh]    Script Date: 12/25/2023 6:28:30 PM ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[sp_qtc_nkpql_create_data_summary_bh]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[sp_qtc_nkpql_create_data_summary_bh]
GO
/****** Object:  StoredProcedure [dbo].[sp_qtc_namkinhphi_quanly_chungtu_index_bh]    Script Date: 12/25/2023 6:28:30 PM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[sp_cp_rpt_get_donvi_nKPQL_lns]    Script Date: 12/25/2023 6:28:30 PM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[sp_bh_qtcqKPk_create_datafor_quaterbefore]    Script Date: 12/25/2023 6:28:30 PM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[sp_bh_qtc_nkp_ql_chitiet]    Script Date: 12/25/2023 6:28:30 PM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[sp_bh_create_quyet_toan_chinamKPQL_chitiet_theo4quy]    Script Date: 12/25/2023 6:28:30 PM ******/
...
SET QUOTED_IDENTIFIER ON
GO
Create PROCEDURE [dbo].[sp_qtc_nkpql_create_data_summary_bh]
@IdChungTu nvarchar(MAX),
...
group by iID_MucLucNganSach,sM,sTM,sNoiDung,sXauNoiMa,iNamLamViec

UPDATE BH_QTC_Nam_KinhPhiQuanLy SET bDaTongHop = 1 WHERE ID_QTC_Nam_KinhPhiQuanLy IN (SELECT * FROM f_split(@LstIdChungTuSummary));
END
;
;
GO
