/****** Object:  StoredProcedure [dbo].[sp_qt_chungtu_chitiet_tao_tonghop]    Script Date: 04/01/2023 6:01:57 PM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[sp_qt_chungtu_chitiet]    Script Date: 04/01/2023 6:01:57 PM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[sp_qs_rpt_tonghop]    Script Date: 04/01/2023 6:01:57 PM ******/
...
BEGIN
    ...
    SELECT 
           ...
           ,null
           ,null
	FROM NS_QT_ChungTuChiTiet WHERE iID_QTChungTu IN (SELECT * FROM f_split(@VoucherIds))
	GROUP BY iID_MLNS, iID_MLNS_Cha, sXauNoiMa, sLNS, sL, sK, sM, sTM, sTTM, sNG, sTNG, sTNG1, sTNG2, sTNG3, bHangCha;
