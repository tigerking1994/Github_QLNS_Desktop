/****** Object:  StoredProcedure [dbo].[sp_qt_chungtu_chitiet_tao_tonghop]    Script Date: 9/4/2024 9:02:25 AM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[sp_qt_chungtu_chitiet]    Script Date: 9/4/2024 9:02:25 AM ******/
...
BEGIN
	...
	SELECT 
			...
			iNamLamViec,fDeNghi_ChuyenNamSau,iID_QTChungTu, fChuyenNamSau_DaCap, fChuyenNamSau_ChuaCap
		INTO #temp2
		 FROM 
...
BEGIN
    ...
    SELECT 
		   ...
		   ,Sum(isnull(fChuyenNamSau_ChuaCap, 0))
           ,null
           ,GetDate()
           ,@UserName
           ,null
