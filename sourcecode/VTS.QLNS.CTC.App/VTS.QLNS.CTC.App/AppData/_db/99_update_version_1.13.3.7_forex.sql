/****** Object:  StoredProcedure [dbo].[sp_nh_kt_khoitaocapphat_chitiet_ById]    Script Date: 10/25/2023 6:20:07 PM ******/
...
BEGIN
	...
	AS
	(
		SELECT *, CAST( ROW_NUMBER() OVER(ORDER by SMaNoiDung) AS nvarchar(max)) AS position FROM #tmppp where IIdParentID IS NULL
		UNION ALL
		SELECT 
				chil.Id,
...
/****** Object:  StoredProcedure [dbo].[sp_nh_delete_duan_qddt_hd_qdk_by_idKhoiTao]    Script Date: 10/26/2023 6:54:53 PM ******/
