/****** Object:  StoredProcedure [dbo].[sp_dc_dutoan_chitiet]    Script Date: 9/25/2024 10:04:34 AM ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[sp_dc_dutoan_chitiet]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[sp_dc_dutoan_chitiet]
GO
/****** Object:  StoredProcedure [dbo].[sp_dc_chungtu_chitiet_tongso]    Script Date: 9/25/2024 4:39:09 PM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[sp_dc_chungtu_chitiet_tao_tonghop]    Script Date: 9/25/2024 4:39:09 PM ******/
...
-- =============================================
CREATE PROCEDURE [dbo].[sp_dc_dutoan_chitiet]
...
select 
	...
	iID_MaNguonNganSach, 
						case 
				when sLNS = '1040200' then sum(fTuChi) + sum(fHangNhap)
				when sLNS = '1040300' then sum(fTuChi) + sum(fHangMua)
				else sum(fTuChi)
...
group by sLNS, iID_MLNS, iID_MLNS_Cha, sXauNoiMa, iNamLamViec, iNamNganSach, iID_MaNguonNganSach
