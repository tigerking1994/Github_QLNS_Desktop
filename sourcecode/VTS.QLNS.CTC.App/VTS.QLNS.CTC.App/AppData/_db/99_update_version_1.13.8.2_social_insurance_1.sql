/****** Object:  StoredProcedure [dbo].[sp_rpt_bhxh_luong_tro_cap_thai_san]    Script Date: 1/11/2024 10:09:51 AM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[sp_rpt_bhxh_luong_tro_cap_om_dau]    Script Date: 1/11/2024 10:09:51 AM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[sp_bhxh_luong_get_can_bo_che_do_index]    Script Date: 1/11/2024 10:09:51 AM ******/
...
BEGIN
	...
	(select Ma_CBo, NAM, thang, Gia_Tri fLuongCanCu from TL_BangLuong_Thang
		...
		and thang = @Thang
		and Ma_PhuCap in ('LHT_TT', 'PCCV_TT', 'PCTN_TT', 'PCTNVK_TT', 'HSBL_TT')) luongcancu on luong.sMaCBo = luongcancu.Ma_CBo
	where 
