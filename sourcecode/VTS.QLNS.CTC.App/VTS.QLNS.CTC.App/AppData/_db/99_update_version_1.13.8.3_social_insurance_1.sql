/****** Object:  StoredProcedure [dbo].[sp_rpt_bhxh_luong_tro_cap_thai_san]    Script Date: 1/12/2024 8:06:22 AM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[sp_rpt_bhxh_luong_tro_cap_om_dau]    Script Date: 1/12/2024 8:06:22 AM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[sp_luong_bhxh_import_qtc_bhxh]    Script Date: 1/12/2024 8:06:22 AM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[sp_bhxh_qtcqn_delete_duplicate_item]    Script Date: 1/12/2024 8:06:22 AM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[sp_bh_get_thang_luong_gan_nhat]    Script Date: 1/12/2024 8:06:22 AM ******/
...
BEGIN
	...
	where ID_QTC_Quy_CheDoBHXH_ChiTiet = (
		select top 1 ID_QTC_Quy_CheDoBHXH_ChiTiet from BH_QTC_Quy_CheDoBHXH_ChiTiet
		where iID_QTC_Quy_CheDoBHXH = @VoucherID
			and iID_MucLucNganSach in (
				select iID_MucLucNganSach from BH_QTC_Quy_CheDoBHXH_ChiTiet
				group by iID_MucLucNganSach
				having count(iID_MucLucNganSach) > 1))
