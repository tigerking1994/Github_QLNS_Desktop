/****** Object:  StoredProcedure [dbo].[sp_bh_export_tonghopcaptamung_kcbbhyt]    Script Date: 4/23/2024 2:50:21 PM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[sp_bh_export_kehoachcaptamung_kcbbhyt]    Script Date: 4/23/2024 2:50:21 PM ******/
...
begin
	...
	begin
		select 
			...
			ROUND(sum(ISNULL(cptu_ct.fQTQuyTruoc,0))/1000000 , 0)*1000000 /@Donvitinh as fQTQuyTruoc, 
...
begin
	...
	begin
		select 
			row_number() over (order by cptu_ct.iID_MaCoSoYTe) as sTT,
			ROUND(ROUND(sum(cptu_ct.fQTQuyTruoc/1000000), 0)*1000000 / @Donvitinh, 0) as fQTQuyTruoc, 
			ROUND(ROUND(sum(cptu_ct.fTamUngQuyNay/1000000), 0)*1000000 /@Donvitinh, 0) as fTamUngQuyNay, 
			ROUND(ROUND(sum(cptu_ct.fLuyKeCapDenCuoiQuy/1000000), 0)*1000000 /@Donvitinh, 0) as fLuyKeCapDenCuoiQuy, 
			cptu_ct.iID_MaCoSoYTe as iID_MaCoSoYTe,
			csyt.sTenCoSoYTe as sTenCoSoYTe
		from BH_CP_CapTamUng_KCB_BHYT_ChiTiet as cptu_ct
		inner join BH_CP_CapTamUng_KCB_BHYT as cptu on cptu_ct.iID_BH_CP_CapTamUng_KCB_BHYT = cptu.iID_BH_CP_CapTamUng_KCB_BHYT
