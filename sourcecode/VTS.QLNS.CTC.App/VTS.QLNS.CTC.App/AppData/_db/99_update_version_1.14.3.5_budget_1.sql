/****** Object:  UserDefinedFunction [dbo].[f_dutoan_tonghop_contain]    Script Date: 17/04/2024 2:18:33 PM ******/
...
GO
/****** Object:  UserDefinedFunction [dbo].[f_dutoan_tonghop]    Script Date: 17/04/2024 2:18:33 PM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[sp_clone_data_update_new]    Script Date: 17/04/2024 5:22:59 PM ******/
	  ...
	  AND iID_DTChungTu in
		(SELECT iID_DTChungTu
		 ...
		 WHERE iNamLamViec = @NamLamViec
		   ...
		   --AND MONTH(CAST(dNgayQuyetDinh AS DATE)) IN (1,2,3) 
		   AND MONTH(CAST(@NgayChungTu AS DATE)) = 12))
