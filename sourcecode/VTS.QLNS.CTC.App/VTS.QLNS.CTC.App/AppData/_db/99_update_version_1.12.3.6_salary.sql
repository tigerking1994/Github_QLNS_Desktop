...
IF NOT EXISTS (SELECT * FROM TL_DM_PHUCAP WHERE Ma_PhuCap = 'TENNGANHANG')
...
VALUES (N'94e76e76-21dd-42e2-8064-912392895eef', NULL, NULL, NULL, 1, NULL, 0, CAST(0.000 AS Numeric(17, 3)), NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, N'TENNGANHANG', NULL, NULL, N'HETHONG', NULL, NULL, NULL, NULL, N'Tên ngân hàng', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, N'Nhập tên ngân hàng')
GO
...
/****** Object:  StoredProcedure [dbo].[sp_tl_update_dmphucap_canbo]    Script Date: 30/11/2022 3:11:41 PM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[sp_tl_get_dm_phucap_hethong]    Script Date: 30/11/2022 3:11:41 PM ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[sp_tl_get_dm_phucap_hethong]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[sp_tl_get_dm_phucap_hethong]
GO
/****** Object:  StoredProcedure [dbo].[sp_tl_rpt_bangthanhtoan_luongthang_2]    Script Date: 01/12/2022 2:55:33 PM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[sp_tl_rpt_bangthanhtoan_luongthang]    Script Date: 01/12/2022 2:55:33 PM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[sp_tl_quyettoan_chungtu_chitiet_tao_tonghop]    Script Date: 02/12/2022 11:32:59 AM ******/
/****** Object:  StoredProcedure [dbo].[sp_tl_bangluong_truylinh_dulieu_insert]    Script Date: 05/12/2022 3:10:07 PM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[sp_tl_bangluong_thang_dulieu_insert]    Script Date: 05/12/2022 3:10:07 PM ******/
...
SET QUOTED_IDENTIFIER ON
GO
CREATE procedure [dbo].[sp_tl_get_dm_phucap_hethong]
...
begin
    ...
    ,[iId_PhuCap_KemTheo]
	from TL_DM_PhuCap where Ma_PhuCap <> 'TENNGANHANG' and (Ma_PhuCap = 'HETHONG' or Parent = 'HETHONG')
    ...
    ,[iId_Ma_PhuCap_KemTheo]
    ,[iId_PhuCap_KemTheo]
	from TL_DM_PhuCap where Ma_PhuCap = 'TENNGANHANG'
...
BEGIN
	...
	BEGIN
		...
		BEGIN
			...
			WHERE TM = 1 AND Thang = @thang AND Nam = @nam
		END
