/****** Object:  StoredProcedure [dbo].[sp_qt_chungtu_chitiet_tao_tonghop]    Script Date: 25/04/2023 5:06:04 PM ******/
...
BEGIN
	...
	JOIN NS_MucLucNganSach mlns ON ctct.sXauNoiMa = mlns.sXauNoiMa AND mlns.iNamLamViec = ctct.iNamLamViec
	WHERE iID_QTChungTu IN (SELECT * FROM f_split(@VoucherIds))
