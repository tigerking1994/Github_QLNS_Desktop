/****** Object:  StoredProcedure [dbo].[sp_rpt_dieu_chinh_du_toan_thu_bhxh_unit_tonghop]    Script Date: 5/2/2024 2:09:14 PM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[sp_rpt_dieu_chinh_du_toan_thu_bhxh_unit]    Script Date: 5/2/2024 2:09:14 PM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[sp_rpt_dieu_chinh_du_toan_thu_bhxh_thctdv]    Script Date: 5/2/2024 2:09:14 PM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[sp_rpt_bhxh_dieu_chinh_dtt_chi_tiet_doi_tuong_tonghop]    Script Date: 5/2/2024 2:09:14 PM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[sp_rpt_bhxh_dieu_chinh_dtt_chi_tiet_doi_tuong]    Script Date: 5/2/2024 2:09:14 PM ******/
...
BEGIN
	...
	left join BH_DTT_BHXH_DieuChinh_ChiTiet ctct on ctct.iID_MaDonVi = pbct.iID_MaDonVi and ctct.sXauNoiMa = pbct.sXauNoiMa and ctct.iNamLamViec = pb.iNamLamViec and pb.bKhoa = 1 and pb.sSoQuyetDinh IS NOT NULL and pb.sSoQuyetDinh <> '' and cast(pb.DngayChungTu as date) <= cast(GETDATE() as date)
	where 
...
BEGIN
	...
	left join BH_DTT_BHXH_DieuChinh_ChiTiet ctct ON ctct.iID_MaDonVi = pbct.iID_MaDonVi and ctct.sXauNoiMa = pbct.sXauNoiMa and ctct.iNamLamViec = pb.iNamLamViec and pb.bIsKhoa = 1 and pb.sSoQuyetDinh IS NOT NULL and pb.sSoQuyetDinh <> '' and cast(pb.DngayChungTu as date) <= cast(GETDATE() as date)
	where 
	pbct.iID_MaDonVi = @MaDonVi
	and pbct.iNamLamViec = @NamLamViec
	and pbct.sLNS = '9020001' -- Khối dự toán
...
BEGIN
	...
	left join BH_DTT_BHXH_DieuChinh_ChiTiet ctct on ctct.iID_MaDonVi = pbct.iID_MaDonVi and ctct.sXauNoiMa = pbct.sXauNoiMa and ctct.iNamLamViec = pb.iNamLamViec and pb.bKhoa = 1 and pb.sSoQuyetDinh IS NOT NULL and pb.sSoQuyetDinh <> '' and cast(pb.DngayChungTu as date) <= cast(GETDATE() as date)
	where 
	pbct.iID_MaDonVi = '002'
	and pbct.iNamLamViec = 2024
	and pbct.sLNS = '9020001' -- Khối dự toán
