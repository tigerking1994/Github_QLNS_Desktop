/****** Object:  StoredProcedure [dbo].[sp_rpt_phanbo_skt_mucluc_don_vi]    Script Date: 10/30/2023 6:11:16 PM ******/
...
GROUP BY iID_MLSKT,
		 ...
		 ---DuToanDuocGiao n -1
		 SELECT  iID_MaDonVi,sXauNoiMa,SUM(ISNULL(fTuChi,0))/@dvt as DuToan INTO #tmpDutoan 		 
		 ...
		 LEFT JOIN #tmpDutoan dutoan on namNay.sKyHieuCu = dutoan.sXauNoiMa and namNay.idDonVi = dutoan.iID_MaDonVi;
