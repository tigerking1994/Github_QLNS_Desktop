...
{
    public class TlDmThueThuNhapCaNhanModelControllerService : GenericControlBaseService<TlDmThueThuNhapCaNhanModel, Core.Domain.TlDmThueThuNhapCaNhan, TlDmThueThuNhapCaNhanService>
    {
        public override ObservableCollection<ComboboxItem> LoadComboboxData(PropertyInfo propertyInfo)
        {
            if (propertyInfo.Name.Equals(nameof(TlDmThueThuNhapCaNhanModel.IIsThueThang)))
            {
        ...
        public override void OrderData()
        {
            ...
            sourceVM.Items = new ObservableCollection<TlDmThueThuNhapCaNhanModel>(datas.OrderByDescending(n => n.IIsThueThang));
        }
    }
}
