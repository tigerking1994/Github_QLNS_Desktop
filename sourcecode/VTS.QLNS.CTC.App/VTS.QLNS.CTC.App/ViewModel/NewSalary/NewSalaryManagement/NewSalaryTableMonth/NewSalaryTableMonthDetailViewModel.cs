...
{
    public class NewSalaryTableMonthDetailViewModel : DetailViewModelBase<TlDSCapNhapBangLuongNq104Model, TlBangLuongThangNq104Model>
    {
        private readonly IMapper _mapper;
        private readonly ISessionService _sessionService;
        private readonly ILog _logger;
        private readonly ITlBangLuongThangNq104Service _tlBangThuongService;
        private readonly ITlBangLuongThangBridgeNq104Service _tlBangThuongBridgeService;
        ...
        public override string FuncCode => NSFunctionCode.NEW_SALARY_MANAGEMENT_SALARY_TABLE_MONTH_DETAIL;
        public override string Title => "BẢNG LƯƠNG THÁNG CHI TIẾT";
        public override string Description => String.Format("Danh sách bảng lương tháng {0} - năm {1} - đơn vị {2}", Model.Thang, Model.Nam, Model.MaCbo);
        public override Type ContentType => typeof(View.NewSalary.NewSalaryManagement.NewSalaryTableMonth.NewSalaryTableMonthDetail);
        ...
        public NewSalaryTableMonthDetailViewModel(
            IMapper mapper,
            ...
            ITlDmCachTinhLuongChuanNq104Service tlDmCachTinhLuongChuanService)
        {
            ...
            _tlBangThuongBridgeService = tlBangThuongBridgeService;
        ...
        public void LoadData()
        {
            ...
            {
                IsLoading = true;
                _tlBangThuongBridgeService.DataPreprocess(Model.Thang, Model.Nam, Model.MaDonVi, "CACH0");
                var data = _tlBangThuongService.GetDataLuongThang(Model.Id);
                e.Result = data;
            }, (s, e) =>
            {
                IsLoading = false;
            ...
            if (SelectedBangLuong != null)
            {
                BackgroundWorkerHelper.Run((s, e) =>
                {
                    ...
                    if (row.Table.Columns.Contains(ExportColumnHeader.MA_CAN_BO))
                    {
                        ...
                        data.Add("TenDonVi", Model.TenDonVi);
