...
namespace VTS.QLNS.CTC.App.ViewModel.NewSalary.NewSalaryManagement.NewCalculateSalary.NewImportCongThuc
{
    public class NewCongThucImportViewModel : ViewModelBase
    {
        ...
        public override Type ContentType => typeof(View.NewSalary.NewSalaryManagement.NewCalculateSalary.NewImportCongThuc.NewCongThucImport);
        ...
        public NewCongThucImportViewModel(ISessionService sessionService,
        ...
        {
            List<TlDmPhuCapNq104> dmPhuCaps= new List<TlDmPhuCapNq104>();
