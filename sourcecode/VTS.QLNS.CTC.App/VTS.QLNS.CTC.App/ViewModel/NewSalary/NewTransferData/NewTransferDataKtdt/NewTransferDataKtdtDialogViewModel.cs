...
{
    public class NewTransferDataKtdtDialogViewModel : ViewModelBase
    {
        private readonly IMapper _mapper;
        private readonly ILog _logger;
        private readonly ISessionService _sessionService;
        //private TlDmDonViService _tlDmDonViService;
        public override Type ContentType => typeof(View.NewSalary.NewTransferData.NewTranferDataKtdt.NewTransferDataKtdtDialog);
        ...
        public override string FuncCode => NSFunctionCode.NEW_SALARY_CHUYEN_DOI_DU_LIEU_KTDT_DIALOG;
        ...
        public NewTransferDataKtdtDialogViewModel(
            IMapper mapper,
