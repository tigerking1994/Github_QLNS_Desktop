...
{
    public class NewTransferDataIndexViewModel : ViewModelBase
    {
        ...
        public override string FuncCode => NSFunctionCode.NEW_SALARY_CHUYEN_DOI_DU_LIEU_DOI_TUONG_INDEX;
        ...
        public override Type ContentType => typeof(View.NewSalary.NewTransferData.NewTransferCadres.NewTransferDataIndex);
        ...
        public NewTransferDataDialogViewModel TransferDataDialogViewModel { get; }
        ...
        public NewTransferDataIndexViewModel(
            ISessionService sessionService,
            IMapper mapper,
            ILog logger,
            NewTransferDataDialogViewModel transferDataDialogViewModel,
        ...
        private void OnRefresh()
        {
            ...
            _lstCanBoPhuCap = new ObservableCollection<TlCanBoPhuCapNq104Model>();
        ...
        private void OnExport()
        {
            BackgroundWorkerHelper.Run((s, e) =>
            {
                ...
                string templateFileName = Path.Combine(ExportPrefix.PATH_TL_LUONG_NEW, ExportFileName.RPT_TL_DANHSACH_FOXPRO_NEW);
