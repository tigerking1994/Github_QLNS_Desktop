...
{
    public class NewTransferDataDialogViewModel : ViewModelBase
    {
        ...
        public ObservableCollection<TlDmDonViNq104Model> lstDonVi { get; set; }
        public ObservableCollection<CadresNq104Model> lstCadres { get; set; }
        public ObservableCollection<TlCanBoPhuCapNq104Model> lstCanBoPhuCap { get; set; }
        ...
        public override string FuncCode => NSFunctionCode.NEW_SALARY_CHUYEN_DOI_DU_LIEU_DOI_TUONG_DIALOG;

        public override Type ContentType => typeof(View.NewSalary.NewTransferData.NewTransferCadres.NewTransferDataDialog);
        ...
        public NewTransferDataDialogViewModel(
            IMapper mapper,
        ...
        {
            List<TlDmDonViNq104> tlDmDonVis = new List<TlDmDonViNq104>();
            if (!IsBienPhong)
            {
                foreach (DataRow item in DtDonVi.Rows)
                {
                    TlDmDonViNq104 tlDmDonVi = new TlDmDonViNq104();
            ...
            lstDonVi = _mapper.Map<ObservableCollection<TlDmDonViNq104Model>>(tlDmDonVis);
        }
        ...
        private void SaveCanBo()
        {
            try
            {
                ...
                var lstImportCanBo = new List<TlDmCanBoNq104>();
                var lstImportPhuCapCanBo = new List<TlCanBoPhuCapNq104>();
                ...
                {
                    TlDmCanBoNq104 tlDmCanBo = new TlDmCanBoNq104();
                    ...
                    var tlCanBoPhuCapModels = new List<TlCanBoPhuCapNq104>();

                    foreach (var item2 in lstPhuCap)
                    {
                        TlCanBoPhuCapNq104 tlCanBoPhuCap = new TlCanBoPhuCapNq104();
                ...
                lstCadres = _mapper.Map<ObservableCollection<CadresNq104Model>>(lstImportCanBo);
                lstCanBoPhuCap = _mapper.Map<ObservableCollection<TlCanBoPhuCapNq104Model>>(lstImportPhuCapCanBo);
            }
            catch (Exception ex)
            {
