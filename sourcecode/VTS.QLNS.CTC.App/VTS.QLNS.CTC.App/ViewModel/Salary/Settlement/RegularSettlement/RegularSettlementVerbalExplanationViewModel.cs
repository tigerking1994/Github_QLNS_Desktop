...
{
    public class RegularSettlementVerbalExplanationViewModel : DialogViewModelBase<TlQtChungTuChiTietGiaiThichModel>
    {
        ...
        public override Type ContentType => typeof(RegularSettlementVerbalExplanation);
        public TlQtChungTuModel ChungTuModel { get; set; }

        public RegularSettlementVerbalExplanationViewModel(
        ...
        {
            Model = new TlQtChungTuChiTietGiaiThichModel();
            TlQtChungTuChiTietGiaiThich entity = _tlQtChungTuChiTietGiaiThichService.FindByChungTuId(ChungTuModel.Id);
            if (entity != null)
            {
                Model = _mapper.Map<TlQtChungTuChiTietGiaiThichModel>(entity);
            }
        }
        ...
        public override void OnSave()
        {
            ...
            {
                // Create
                entity = new TlQtChungTuChiTietGiaiThich();
