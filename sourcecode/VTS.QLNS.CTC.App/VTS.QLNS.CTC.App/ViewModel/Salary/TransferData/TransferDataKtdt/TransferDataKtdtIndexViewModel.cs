...
{
    public class TransferDataKtdtIndexViewModel : ViewModelBase
    {
        ...
        private List<TlCanBoPhuCapModel> _lstCanBoPhuCap;

        public override string FuncCode => NSFunctionCode.SALARY_CHUYEN_DOI_DU_LIEU_KTDT_INDEX;
        ...
        public override Type ContentType => typeof(View.Salary.TransferData.TranferDataKtdt.TransferDataKtdtIndex);
        ...
        public TransferDataKtdtDialogViewModel TransferDataKtdtDialogViewModel { get; }
        public TransferDataDetailViewModel TransferDataDetailViewModel { get; }

        public RelayCommand OpenCommand { get; }

        public TransferDataKtdtIndexViewModel(
        ...
        public override void OnSave()
        {
            ...
            _lstCanBoPhuCap = new List<TlCanBoPhuCapModel>();
            SaveDonVi();
            SaveCanBo();
            ...
            else
            {
                ...
                TransferDataDetailViewModel.LstCanBoPhuCap = new ObservableCollection<TlCanBoPhuCapModel>(_lstCanBoPhuCap);
        ...
        private void SaveCanBo()
        {
            ...
            foreach (DataRow item in DtDoiTuong.Rows)
            {
                ...
                var tlCanBoPhuCapModels = new List<TlCanBoPhuCapModel>();

                foreach (var item1 in lstPhuCap)
                {
                    TlCanBoPhuCapModel tlCanBoPhuCapModel = new TlCanBoPhuCapModel();
        ...
        private void SaveDonVi()
        {
            ...
            {
                TlDmDonViModel tlDmDonVi = new TlDmDonViModel();
