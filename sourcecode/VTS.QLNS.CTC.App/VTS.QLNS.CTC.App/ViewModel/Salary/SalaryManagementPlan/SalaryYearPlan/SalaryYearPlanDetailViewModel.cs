...
{
    public class SalaryYearPlanDetailViewModel : DetailViewModelBase<TlDsBangLuongKeHoachModel, TlBangLuongKeHoachModel>
    {
        ...
        private readonly ITlPhuCapMlnsService _iTlPhuCapMlnsService;
        ...
        private readonly ITlDmCanBoKeHoachService _iDmCanBoKeHoachService;
        ...
        public override string FuncCode => NSFunctionCode.SALARY_QUAN_LY_LUONG_KE_HOACH_BANG_LUONG_NAM_KH_DETAIL;

        public override string GroupName => MenuItemContants.GROUP_FUNCTION;
        public override string Name => "Bảng lương năm kế hoạch";
        public override Type ContentType => typeof(View.Salary.SalaryManagementPlan.SalaryYearPlan.SalaryYearPlanDetail);
        ...
        private ObservableCollection<TlQtChungTuChiTietKeHoachModel> _itemsChungTuChiTiet;
        public ObservableCollection<TlQtChungTuChiTietKeHoachModel> ItemsChungTuChiTiet
        {
            get => _itemsChungTuChiTiet;
            set => SetProperty(ref _itemsChungTuChiTiet, value);
        }

        private TlQtChungTuChiTietKeHoachModel _selectedItemChungTu;
        public TlQtChungTuChiTietKeHoachModel SelectedItemChungTu
        {
        ...
        public SalaryYearPlanVolatilityViewModel VolatilitySalaryYearPlanDialogViewModel { get; }
        public ReportDialogViewModel ReportDialogViewModel { get; }

        public RelayCommand ShowPopupDetailCommand { get; }
        public RelayCommand ExportBcMlnsCommand { get; }

        public SalaryYearPlanDetailViewModel(
            IMapper mapper,
            ...
            ITlPhuCapMlnsService iTlPhuCapMlnsService,
            IDanhMucService danhMucService,
            INsDonViService donViService,
            ITlDmCanBoKeHoachService iDmCanBoKeHoachService,
            ITlBaoCaoService tlBaoCaoService,
            ITlDmDonViService tlDmDonViService,
            SalaryYearPlanVolatilityViewModel volatilitySalaryYearPlanDialogViewModel,
        ...
        public override void LoadData(params object[] args)
        {
            ...
            _itemsChungTuChiTiet = _mapper.Map<ObservableCollection<TlQtChungTuChiTietKeHoachModel>>(data);
        ...
        private void CalculateData(List<TlQtChungTuChiTietKeHoachModel> lstQtChungTuChiTiet)
        {
        ...
        private void CalculateParent(Guid? idParent, TlQtChungTuChiTietKeHoachModel item, List<TlQtChungTuChiTietKeHoachModel> lstQtChungTuChiTiet)
        {
        ...
        private void OnOpenReportDialog()
        {
            ...
            TlRptLuongKeHoachModel tlRptLuongKeHoachModel = new TlRptLuongKeHoachModel();
            ...
            ReportDialogViewModel.ShowDialogHost("SalaryDetailDialog");
        }

        protected override void OnSelectionDoubleClick(object obj)
        {
            base.OnSelectionDoubleClick(obj);
            OnOpenCadresDetail((TlQtChungTuChiTietKeHoachModel)obj);
        }

        private void OnOpenCadresDetail(TlQtChungTuChiTietKeHoachModel obj)
        {
            try
            {
        ...
        public override void OnSave()
        {
            ...
            var lstAddEntity = new List<TlQtChungTuChiTietKeHoach>();
            foreach (var item in lstAdd)
            {
                TlQtChungTuChiTietKeHoach tlQtChungTuChiTietKeHoach = new TlQtChungTuChiTietKeHoach();
                tlQtChungTuChiTietKeHoach = _mapper.Map<TlQtChungTuChiTietKeHoach>(item);
            ...
            var lstUpdateEntity = new List<TlQtChungTuChiTietKeHoach>();
        ...
        {
            TlQtChungTuChiTietKeHoachModel item = (TlQtChungTuChiTietKeHoachModel)sender;
            if (args.PropertyName == nameof(TlQtChungTuChiTietKeHoachModel.GhiChu) || args.PropertyName == nameof(TlQtChungTuChiTietKeHoachModel.DieuChinh))
            {
                if (args.PropertyName == nameof(TlQtChungTuChiTietKeHoachModel.DieuChinh))
                {
                    if (item.DieuChinh != null && item.TongNamTruoc == null)
                    {
                        item.ChenhLech = item.DieuChinh;
        ...
        private void ExportLuongNam(ExportType exportType)
        {
            try
            {
                BackgroundWorkerHelper.Run((s, e) =>
                {
                    ...
                    var xlsFile = _exportService.Export<TlChungTuChiTietKeHoachQuery>(templateFileName, data);
        ...
        private void CalculateDieuChinhParent(TlQtChungTuChiTietKeHoachModel currentItem, TlQtChungTuChiTietKeHoachModel selfItem)
        {
        ...
        {
            bool result = true;
            var item = (TlQtChungTuChiTietKeHoachModel)obj;
        ...
        private void ExportChiTietCanBoMlns(ExportType exportType)
        {
            try
            {
                BackgroundWorkerHelper.Run((s, e) =>
                {
                    ...
                    dic.Add("Items", results.Where(x => x.HasDataMonth || x.IsShow));
                    ...
                    string templateFileName = Path.Combine(ExportPrefix.PATH_TL_LUONG, ExportFileName.RPT_TL_CHITIET_CANBO_KEHOACH);
