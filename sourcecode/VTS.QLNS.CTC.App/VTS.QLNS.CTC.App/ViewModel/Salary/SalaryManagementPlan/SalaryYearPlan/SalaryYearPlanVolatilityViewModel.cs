...
{
    public class SalaryYearPlanVolatilityViewModel : DialogViewModelBase<TlQtChungTuChiTietKeHoachModel>
    {
        ...
        private ITlDmCanBoKeHoachService _tlDmCanBoKeHoachService;
        private ITlBangLuongKeHoachService _tlBangLuongKeHoachService;
        private ITlBangLuongThangService _tlBangLuongThangService;
        private ITlQtChungTuChiTietKeHoachService _tlQtChungTuChiTietKeHoachService;
        ...
        private List<TlBangLuongThang> _lstBangLuongThang;
        private List<TlBangLuongKeHoach> _lstBangLuongKeHoachs;
        private List<TlDmCanBoKeHoach> _lstCanBoKeHoaches;
        private List<TlQtChungTuChiTietKeHoach> _lstChungTuChiTietKeHoach;
        ...
        public override Type ContentType => typeof(View.Salary.SalaryManagementPlan.SalaryYearPlan.SalaryYearPlanVolatility);
        ...
        public SalaryYearPlanVolatilityViewModel(
            IMapper mapper,
        ...
        private void ExportChiTiet(ExportType exportType)
        {
            try
            {
                BackgroundWorkerHelper.Run((s, e) =>
                {
                    ...
                    string templateFileName = Path.Combine(ExportPrefix.PATH_TL_LUONG, ExportFileName.RPT_TL_BIEN_DONG_LUONG);
        ...
        private List<TlBienDongLuongThangChiTietModel> GetDataChiTiet(int thang)
        {
            ...
            int stt = 0;
            var lstCanBo = new List<TlDmCanBoKeHoach>();
