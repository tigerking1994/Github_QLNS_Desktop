...
{
    public class SalaryTableMonthDialogViewModel : DialogViewModelBase<TlDSCapNhapBangLuongModel>
    {
        ...
        public override Type ContentType => typeof(View.Salary.SalaryManagement.SalaryTableMonth.SalaryTableMonthDialog);
        ...
        public SalaryTableMonthDialogViewModel(
            ILog logger,
            IMapper mapper,
        ...
        private void LoadDanhMucDonVi()
        {
            ...
            if (SelectedMonth != null && SelectedYear != null)
            {
                ...
                var data = _tlDmDonViService.FindDonViTaoBangLuong(nam, thang, CachTinhLuong.CACH0).OrderBy(x => x.XauNoiMa).ThenBy(x => x.MaDonVi).ToList();
        ...
        public override void OnSave()
        {
            ...
            else
            {
                ...
                BackgroundWorkerHelper.Run((s, e) =>
                {
                    ...
                    var objTiLeHuongTamGiamTamGiu = _dmPhuCapService.FindByMaPhuCap(PhuCap.TILE_HUONGTGTG);
                    decimal fTiLeHuongNn = 1;
                    decimal fTiLeHuongTamGiamTamGiu = 1;
                    if (objTiLeHuongNN != null)
                    {
                        fTiLeHuongNn = objTiLeHuongNN.GiaTri ?? 1;
                    }
                    if (objTiLeHuongTamGiamTamGiu != null)
                    {
                        fTiLeHuongTamGiamTamGiu = objTiLeHuongTamGiamTamGiu.GiaTri ?? 1;
                    }
