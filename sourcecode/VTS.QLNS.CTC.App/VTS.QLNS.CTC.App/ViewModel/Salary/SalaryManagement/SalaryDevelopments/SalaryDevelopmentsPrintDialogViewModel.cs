...
{
    public class SalaryDevelopmentsPrintDialogViewModel : DialogViewModelBase<TlRptDienBienLuongQuery>
    {
        ...
        public override Type ContentType => typeof(View.Salary.SalaryManagement.SalaryDevelopments.SalaryDevelopmentsPrintDialog);
        ...
        public SalaryDevelopmentsPrintDialogViewModel(
            IMapper mapper,
        ...
        private void OnPrint()
        {
            ...
            string templateFileName = Path.Combine(ExportPrefix.PATH_TL_LUONG, ExportFileName.RPT_TL_DIENBIEN_LUONG_CANBO);
