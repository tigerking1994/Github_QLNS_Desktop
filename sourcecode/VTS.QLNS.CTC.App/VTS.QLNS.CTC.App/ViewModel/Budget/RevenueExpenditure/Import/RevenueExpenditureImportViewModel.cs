...
{
    public class RevenueExpenditureImportViewModel : ViewModelBase
    {
        ...
        public RevenueExpenditureImportViewModel(IMapper mapper,
        ...
        private void OnProcessFile()
        {
            ...
            ShowError:
                ...
                if (RevenueExpenditureImportTypes.Equals(RevenueExpenditureImportType.PLAN_BUDGET_IMPORT_EXPORT)
                    || RevenueExpenditureImportTypes.Equals(RevenueExpenditureImportType.APPROVED_ESTIMATION_IMPORT_EXPORT)
                    || RevenueExpenditureImportTypes.Equals(RevenueExpenditureImportType.REVENUE_EXPENDITURE_DIVISION_IMPORT_EXPORT))
                {
                    //xử lý chứng từ chi tiết
                    ImportResult<RevenueExpenditurePlanDetailImportModel> _voucherDetailResult = _importService.ProcessData<RevenueExpenditurePlanDetailImportModel>(FilePath);
                    _settlementVoucherDetails = new ObservableCollection<RevenueExpenditurePlanDetailImportModel>(_voucherDetailResult.Data);
                    ...
                    foreach (var item in _settlementVoucherDetails)
                    {
                        item.PropertyChanged += (sender, args) =>
                        {
                            ...
                            {
                                var voucherDetail = (RevenueExpenditurePlanDetailImportModel)sender;
                                int rowIndex = _settlementVoucherDetails.IndexOf(voucherDetail);
                                var listError = _importService.ValidateItem<RevenueExpenditurePlanDetailImportModel>(voucherDetail, rowIndex);
        ...
        private void OnSaveData()
        {
            try
            {
                ...
                || RevenueExpenditureImportTypes.Equals(RevenueExpenditureImportType.REVENUE_EXPENDITURE_DIVISION_IMPORT_EXPORT))
                {
                    TnDtChungTu chungTu = new TnDtChungTu();
                    List<TnDtChungTuChiTiet> chungTuChiTiets = _mapper.Map<List<TnDtChungTuChiTiet>>(_settlementVoucherDetails.Where(x => x.ImportStatus));
                    List<ImpTnDtThuNop> thuNops = _mapper.Map<List<ImpTnDtThuNop>>(_settlementVoucherDetails.Where(x => x.ImportStatus));
                    ...
                    if (RevenueExpenditureImportTypes.Equals(RevenueExpenditureImportType.PLAN_BUDGET_IMPORT_EXPORT))
                    {
                        chungTu.SoChungTu = "LT-" + soChungTuIndex.ToString("D3");
                        chungTu.ILoai = RevenueAndExpenditureType.PlanEstimation;
                        chungTu.IdDonVi = _agencySelected.ValueItem;
                        chungTu.TenDonVi = _agencySelected.DisplayItem;
                    }
                    else if (RevenueExpenditureImportTypes.Equals(RevenueExpenditureImportType.APPROVED_ESTIMATION_IMPORT_EXPORT))
                    {
                        chungTu.SoChungTu = "DT-" + soChungTuIndex.ToString("D3");
                        chungTu.ILoai = RevenueAndExpenditureType.ApprovedEstimation;
                        chungTu.IdDonVi = _sessionService.Current.IdDonVi;
                    }
                    else if (RevenueExpenditureImportTypes.Equals(RevenueExpenditureImportType.REVENUE_EXPENDITURE_DIVISION_IMPORT_EXPORT))
                    {
                        chungTu.SoChungTu = "CT-" + soChungTuIndex.ToString("D3");
                        chungTu.ILoai = RevenueAndExpenditureType.DivisionEstimation;
                        chungTu.IdDonVi = _agencySelected.ValueItem;
                        chungTu.TenDonVi = _agencySelected.DisplayItem;
                    }
                    ...
                    if (RevenueExpenditureImportTypes.Equals(RevenueExpenditureImportType.REVENUE_EXPENDITURE_DIVISION_IMPORT_EXPORT))
                    {
                        chungTu.IdDotNhan = DataDotSelected.ValueItem;
                    }
                    ...
                    foreach (var item in chungTuChiTiets)
                    {
                        ...
                        item.IdDonVi = _sessionService.Current.IdDonVi;
                        item.UserCreator = _sessionService.Current.Principal;
                        item.DateCreated = DateTime.Now;

                        if (RevenueExpenditureImportTypes.Equals(RevenueExpenditureImportType.PLAN_BUDGET_IMPORT_EXPORT))
                        {
                            item.IPhanCap = RevenueAndExpenditureType.PlanEstimation;
                        }
                        else if (RevenueExpenditureImportTypes.Equals(RevenueExpenditureImportType.APPROVED_ESTIMATION_IMPORT_EXPORT))
                        {
                            item.IPhanCap = RevenueAndExpenditureType.ApprovedEstimation;
                        }
                        else if (RevenueExpenditureImportTypes.Equals(RevenueExpenditureImportType.REVENUE_EXPENDITURE_DIVISION_IMPORT_EXPORT))
                        {
                            item.IPhanCap = RevenueAndExpenditureType.DivisionEstimation;
                        }
                    }

                    _tnDtChungTuChiTietService.AddRange(chungTuChiTiets);
                    ...
                    foreach (var item in thuNops)
                    {
                        ...
                        if (RevenueExpenditureImportTypes.Equals(RevenueExpenditureImportType.PLAN_BUDGET_IMPORT_EXPORT))
                            item.Iloai = RevenueAndExpenditureType.PlanEstimation;
                        else if (RevenueExpenditureImportTypes.Equals(RevenueExpenditureImportType.APPROVED_ESTIMATION_IMPORT_EXPORT))
                            item.Iloai = RevenueAndExpenditureType.ApprovedEstimation;
                        else if (RevenueExpenditureImportTypes.Equals(RevenueExpenditureImportType.REVENUE_EXPENDITURE_DIVISION_IMPORT_EXPORT))
                            item.Iloai = RevenueAndExpenditureType.DivisionEstimation;
                    }

                    _impTnDtThuNopService.AddRange(thuNops);

                    TnDtChungTuModel settlementVoucher = _mapper.Map<TnDtChungTuModel>(chungTu);
                ...
                else if (RevenueExpenditureImportTypes.Equals(RevenueExpenditureImportType.REAL_REVENUE_EXPENDITURE_IMPORT_EXPORT))
                {
                    ...
                    chungTu.SThangQuyMoTa = _quarterMonthSelected.DisplayItem;
