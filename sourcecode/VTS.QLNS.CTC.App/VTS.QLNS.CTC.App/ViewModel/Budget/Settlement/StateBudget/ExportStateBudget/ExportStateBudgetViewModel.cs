...
namespace VTS.QLNS.CTC.App.ViewModel.Budget.Settlement.StateBudget.ExportStateBudget
{
    public class ExportStateBudgetViewModel : DialogViewModelBase<SettlementVoucherModel>
    {
        ...
        public override Type ContentType => typeof(View.Budget.Settlement.StateBudget.ExportStateBudget.ExportStateBudget);
        ...
        public ExportStateBudgetViewModel(ILog logger,
                                          IMapper mapper,
