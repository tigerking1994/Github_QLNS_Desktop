...
namespace VTS.QLNS.CTC.App.ViewModel.Budget.Settlement.ForexBudget.ExportForexBudget
{
    public class ExportForexBudgetViewModel : DialogViewModelBase<SettlementVoucherModel>
    {
        ...
        public override Type ContentType => typeof(View.Budget.Settlement.ForexBudget.ExportForexBudget.ExportForexBudget);
        ...
        public ExportForexBudgetViewModel(ILog logger,
                                          IMapper mapper,
