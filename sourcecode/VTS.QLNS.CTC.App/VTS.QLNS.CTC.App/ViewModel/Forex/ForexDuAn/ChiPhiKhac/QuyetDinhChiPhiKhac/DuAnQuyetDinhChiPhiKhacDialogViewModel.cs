...
{
    public class DuAnQuyetDinhChiPhiKhacDialogViewModel : DialogViewModelBase<NhDaQuyetDinhKhacModel>
    {
        ...
        public override System.Type ContentType => typeof(DuAnQuyetDinhChiPhiKhacDialog);
        ...
        public DuAnQuyetDinhChiPhiKhacDialogViewModel(
            ILog logger,
            IMapper mapper,
        ...
        public override void LoadData(params object[] args)
        {
            ...
            else
            {
                ...
                if (Model.IIdKHTTNhiemVuChiId != null)
                {
                    ...
                    var listNhiemVuChi = _nhKhTongTheNhiemVuChiService.FindByIdKhTongTheAndMaDonVi(IIdKhTongTheId, _selectedDonVi != null ? _selectedDonVi.IIDMaDonVi : string.Empty);
        ...
        private void CalculateChiPhi()
        {
            ...
            FSumGiaTriVnd = Model.FGiaTriVnd;
            FSumGiaTriUsd = Model.FGiaTriUsd;
            OnPropertyChanged(nameof(Model));
        }
