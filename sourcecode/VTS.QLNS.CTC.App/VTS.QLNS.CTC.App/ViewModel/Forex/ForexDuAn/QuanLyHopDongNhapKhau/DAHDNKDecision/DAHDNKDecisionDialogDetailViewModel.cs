...
{
    public class DAHDNKDecisionDialogDetailViewModel : DialogAttachmentViewModelBase<NhDaGoiThauModel>
    {
        ...
        public override Type ContentType => typeof(DAHDNKDecisionDialogDetail);
        ...
        public DAHDNKDecisionDialogDetailItemsViewModel DAHDNKDecisionDialogDetailItemsViewModel { get; }

        public DAHDNKDecisionDialogDetailViewModel
        (
            IMapper mapper,
            ...
            DAHDNKDecisionDialogDetailItemsViewModel DAHDNKdecisionDialogDetailItemsViewModel
        ...
        private void LoadGoiThauNguonVon()
        {
            ...
            if (!Model.Id.IsNullOrEmpty())
            {
                ...
                if (!data.IsEmpty())
                {
                    ...
                    ItemsGoiThauNguonVon.ForAll(item =>
                    {
        ...
        private void OnShowHangMucDetail()
        {
            ...
            DAHDNKDecisionDialogDetailItemsViewModel.Model = SelectedChiPhi;
            DAHDNKDecisionDialogDetailItemsViewModel.Init();
            DAHDNKDecisionDialogDetailItemsViewModel.ShowDialogHost("DecisionDialogDetailItems");
        }
