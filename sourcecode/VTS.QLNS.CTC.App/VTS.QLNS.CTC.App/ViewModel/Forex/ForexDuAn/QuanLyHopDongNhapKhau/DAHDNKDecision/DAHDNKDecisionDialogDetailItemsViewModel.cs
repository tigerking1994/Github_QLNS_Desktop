...
{
    public class DAHDNKDecisionDialogDetailItemsViewModel : DetailViewModelBase<NhDaGoiThauChiPhiModel, NhDaGoiThauHangMucModel>
    {
        ...
        public override Type ContentType => typeof(DAHDNKDecisionDialogDetailItems);
        ...
        public DAHDNKDecisionDialogDetailItemsViewModel(IMapper mapper)
        {
            _mapper = mapper;
        }
