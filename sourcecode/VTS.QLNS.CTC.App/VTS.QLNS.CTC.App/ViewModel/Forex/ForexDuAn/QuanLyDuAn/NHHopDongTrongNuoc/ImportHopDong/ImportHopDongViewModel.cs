...
namespace VTS.QLNS.CTC.App.ViewModel.Forex.ForexDuAn.QuanLyDuAn.NHHopDongTrongNuoc.ImportHopDong

{
    public class ImportHopDongViewModel : ViewModelBase
    {
        ...
        public override Type ContentType => typeof(View.Forex.ForexDuAn.QuanLyDuAn.NHHopDongTrongNuoc.ImportHopDong.ImportHopDong);
        ...
        public NHHopDongTrongNuocDialogViewModel NHHopDongTrongNuocDialogViewModel { get; set; }
        ...
        public ImportHopDongViewModel(ISessionService sessionService,
            ILog logger,
            IMapper mapper,
        ...
        private List<NhDaHopDongModel> ConvertData(List<HopDongTrongNuocDuAnImportModel> importModels, bool isAddMessage = true)
        {
            ...
            IEnumerable<NhDaDuAnQuery> nhDaDuAns = _nhDaDuAnService.FindIndex(2).Where(x => x.IIdDonViQuanLyId == SelectedDonVi.Id);
