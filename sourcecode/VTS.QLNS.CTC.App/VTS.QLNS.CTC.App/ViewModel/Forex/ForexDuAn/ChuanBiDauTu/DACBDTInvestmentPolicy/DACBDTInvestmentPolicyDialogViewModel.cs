...
using VTS.QLNS.CTC.App.View.Forex.ForexDuAn.ChuanBiDauTu.DACBDTInvestmentPolicy;
...
namespace VTS.QLNS.CTC.App.ViewModel.Forex.ForexDuAn.ChuanBiDauTu.DACBDTInvestmentPolicy
{
    public class DACBDTInvestmentPolicyDialogViewModel : DialogCurrencyAttachmentViewModelBase<NhDaChuTruongDauTuModel>
    {
        ...
        public override Type ContentType => typeof(DACBDTInvestmentPolicyDialog);
        ...
        public DACBDTInvestmentPolicyDialogViewModel(
            ILog logger,
            IMapper mapper,
        ...
        private void LoadDuAn()
        {
            ...
            if (_selectedDonVi != null)
            {
                ...
                {
                    data = _nhDaDuAnService.FindFromChuTruongDauTu(yearOfWork, maDonVi).Where(x => x.ILoai == 2);
                }
                else
                {
                    data = _nhDaDuAnService.FindFromChuTruongDauTu(yearOfWork, maDonVi, Model.Id).Where(x => x.ILoai == 2);
                }
        ...
        private void ChuTruongDauTuNguonVon_PropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
            ...
            ////KhaiPD: Tính giá trị tiền tệ khác
            //Guid idTyGia = (Guid)SelectedTiGia.Id;
            ...
            //{
            //    case nameof(NhDaQdDauTuHangMucModel.FGiaTriUsd):
            //        value = Convert.ToDouble(objectSender.FGiaTriUsd.GetValueOrDefault());
            //        objectSender.FGiaTriVnd = _iNhDmTiGiaService.CurrencyExchange("USD", "VND", rootCurrency, listTyGiaCT, value);
            //        objectSender.FGiaTriEur = _iNhDmTiGiaService.CurrencyExchange("USD", "EUR", rootCurrency, listTyGiaCT, value);
            //        objectSender.FGiaTriNgoaiTeKhac = _iNhDmTiGiaService.CurrencyExchange("USD", ngoaiTeKhac, rootCurrency, listTyGiaCT, value);
            //        break;
            //    case nameof(NhDaQdDauTuHangMucModel.FGiaTriEur):
            //        value = Convert.ToDouble(objectSender.FGiaTriEur.GetValueOrDefault());
            //        objectSender.FGiaTriVnd = _iNhDmTiGiaService.CurrencyExchange("EUR", "VND", rootCurrency, listTyGiaCT, value);
            //        objectSender.FGiaTriUsd = _iNhDmTiGiaService.CurrencyExchange("EUR", "USD", rootCurrency, listTyGiaCT, value);
            //        objectSender.FGiaTriNgoaiTeKhac = _iNhDmTiGiaService.CurrencyExchange("EUR", ngoaiTeKhac, rootCurrency, listTyGiaCT, value);
            //        break;
            //    case nameof(NhDaQdDauTuHangMucModel.FGiaTriVnd):
            //        value = Convert.ToDouble(objectSender.FGiaTriVnd.GetValueOrDefault());
            //        objectSender.FGiaTriUsd = _iNhDmTiGiaService.CurrencyExchange("VND", "USD", rootCurrency, listTyGiaCT, value);
            //        objectSender.FGiaTriEur = _iNhDmTiGiaService.CurrencyExchange("VND", "EUR", rootCurrency, listTyGiaCT, value);
            //        objectSender.FGiaTriNgoaiTeKhac = _iNhDmTiGiaService.CurrencyExchange("VND", ngoaiTeKhac, rootCurrency, listTyGiaCT, value);
            //        break;
            //    case nameof(NhDaQdDauTuHangMucModel.FGiaTriNgoaiTeKhac):
            //        value = Convert.ToDouble(objectSender.FGiaTriNgoaiTeKhac.GetValueOrDefault());
            //        objectSender.FGiaTriUsd = _iNhDmTiGiaService.CurrencyExchange(ngoaiTeKhac, "USD", rootCurrency, listTyGiaCT, value);
            //        objectSender.FGiaTriEur = _iNhDmTiGiaService.CurrencyExchange(ngoaiTeKhac, "EUR", rootCurrency, listTyGiaCT, value);
            //        objectSender.FGiaTriVnd = _iNhDmTiGiaService.CurrencyExchange(ngoaiTeKhac, "VND", rootCurrency, listTyGiaCT, value);
            //        break;
            //    default:
            //        break;
            //}
