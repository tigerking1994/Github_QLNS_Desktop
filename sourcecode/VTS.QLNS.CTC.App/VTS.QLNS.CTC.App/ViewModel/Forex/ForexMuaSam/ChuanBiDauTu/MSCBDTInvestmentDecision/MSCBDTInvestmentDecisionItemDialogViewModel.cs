...
{
    public class MSCBDTInvestmentDecisionItemDialogViewModel : DetailViewModelBase<NhDaQdDauTuChiPhiModel, NhDaQdDauTuHangMucModel>
    {
        ...
        public override Type ContentType => typeof(MSCBDTInvestmentDecisionItemDialog);
        ...
        public MSCBDTInvestmentDecisionItemDialogViewModel(
            ILog logger,
            IMapper mapper,
            ...
            bool isParent = true)
        {
            ...
            foreach (var item in Items)
            {
                if (item.IIdGocId == entity.IIdParentId)
                {
        ...
        private void SaveItems()
        {
            ...
            //{
            //    var item = Items[i];
            //    if (item?.FGiaTriUsd == null || item?.FGiaTriUsd == 0
