...
{
    public class MSCTNThietKeKyThuatTongDuToanIndexViewModel : GridViewModelBase<NhDaDuToanModel>
    {
        ...
        public MSCTNThietKeKyThuatTongDuToanDialogViewModel NhDaDuToanDialogViewModel { get; }
        ...
        public MSCTNThietKeKyThuatTongDuToanIndexViewModel(
            ILog logger,
            IMapper mapper,
            ISessionService sessionService,
            INsDonViService nsDonViService,
            INhDaDuToanService nhDaDuToanService,
            MSCTNThietKeKyThuatTongDuToanDialogViewModel nhDaDuToanDialogViewModel,
        ...
        private bool Items_Filter(object obj)
        {
            if (obj is NhDaDuToanModel item)
            {
                ...
                {
                    result &= item.IIdKHTTNhiemVuChiId.Equals(SelectedChuongTrinh.Id);
                }
                return result;
            }
