...
{
    public class MSCTNThietKeKyThuatTongDuToanHangMucDivideViewModel : DetailViewModelBase<VdtDuToanModel, DuToanDetailModel>
    {
        ...
        public MSCTNThietKeKyThuatTongDuToanHangMucDivideViewModel()
        {
