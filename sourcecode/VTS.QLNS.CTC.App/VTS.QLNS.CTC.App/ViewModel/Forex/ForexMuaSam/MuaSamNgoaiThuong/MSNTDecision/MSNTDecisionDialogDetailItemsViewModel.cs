...
{
    public class MSNTDecisionDialogDetailItemsViewModel : DetailViewModelBase<NhDaGoiThauChiPhiModel, NhDaGoiThauHangMucModel>
    {
        ...
        public override Type ContentType => typeof(MSNTDecisionDialogDetailItems);
        ...
        public MSNTDecisionDialogDetailItemsViewModel(IMapper mapper)
        {
            _mapper = mapper;
        }
