...
{
    public class MSNTDecisionDialogDetailViewModel : DialogAttachmentViewModelBase<NhDaGoiThauModel>
    {
        ...
        public override Type ContentType => typeof(MSNTDecisionDialogDetail);
        ...
        public MSNTDecisionDialogDetailItemsViewModel MSNTDecisionDialogDetailItemsViewModel { get; }

        public MSNTDecisionDialogDetailViewModel
        (
            IMapper mapper,
            ...
            MSNTDecisionDialogDetailItemsViewModel msntdecisionDialogDetailItemsViewModel
        ...
        private void OnShowHangMucDetail()
        {
            ...
            MSNTDecisionDialogDetailItemsViewModel.Model = SelectedChiPhi;
            MSNTDecisionDialogDetailItemsViewModel.Init();
            MSNTDecisionDialogDetailItemsViewModel.ShowDialogHost("DecisionDialogDetailItems");
        }
