...
{
    public class MSNTThietKeKyThuatTongDuToanHangMucDivideViewModel : DetailViewModelBase<VdtDuToanModel, DuToanDetailModel>
    {
        ...
        public MSNTThietKeKyThuatTongDuToanHangMucDivideViewModel()
        {
