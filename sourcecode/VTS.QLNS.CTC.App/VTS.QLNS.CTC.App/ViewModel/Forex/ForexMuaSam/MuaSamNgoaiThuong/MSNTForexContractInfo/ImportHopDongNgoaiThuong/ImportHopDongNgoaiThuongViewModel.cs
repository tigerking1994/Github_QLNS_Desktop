...
namespace VTS.QLNS.CTC.App.ViewModel.Forex.ForexMuaSam.MuaSamNgoaiThuong.MSNTForexContractInfo.ImportHopDongNgoaiThuong
{
    public class ImportHopDongNgoaiThuongViewModel : ViewModelBase
    {
        ...
        {
            var lst = _nhDaHopDongService.FindAllHopDongNgoaiThuong(1);
