...
{
    public class MSNTNHPhuongAnNhapKhauIndexViewModel : GridViewModelBase<NhHdnkPhuongAnNhapKhauModel>
    {
        ...
        public override Type ContentType => typeof(MSNTNHPhuongAnNhapKhauIndex);
        ...
        public MSNTNHPhuongAnNhapKhauDialogViewModel MSNTNHPhuongAnNhapKhauDialogViewModel { get; }

        public MSNTNHPhuongAnNhapKhauIndexViewModel
        (
            ILog logger,
            IMapper mapper,
            ...
            MSNTNHPhuongAnNhapKhauDialogViewModel msntnhPhuongAnNhapKhauDialogViewModel
        )
        {
            _logger = logger;
            _mapper = mapper;
        ...
        {
            MSNTNHPhuongAnNhapKhauDialogViewModel.Model = new NhHdnkPhuongAnNhapKhauModel();
            MSNTNHPhuongAnNhapKhauDialogViewModel.BIsReadOnly = false;
            MSNTNHPhuongAnNhapKhauDialogViewModel.IsDieuChinh = false;
            MSNTNHPhuongAnNhapKhauDialogViewModel.IsAdd = true;
            MSNTNHPhuongAnNhapKhauDialogViewModel.ILoai = this.ILoai;
            MSNTNHPhuongAnNhapKhauDialogViewModel.Init();
            MSNTNHPhuongAnNhapKhauDialogViewModel.SavedAction = obj => this.OnRefresh();
            MSNTNHPhuongAnNhapKhauDialogViewModel.ShowDialog();
        }

        protected override void OnUpdate()
        {
            MSNTNHPhuongAnNhapKhauDialogViewModel.Model = SelectedItem;
            MSNTNHPhuongAnNhapKhauDialogViewModel.BIsReadOnly = false;
            MSNTNHPhuongAnNhapKhauDialogViewModel.IsDieuChinh = false;
            MSNTNHPhuongAnNhapKhauDialogViewModel.IsAdd = false;
            MSNTNHPhuongAnNhapKhauDialogViewModel.ILoai = this.ILoai;
            MSNTNHPhuongAnNhapKhauDialogViewModel.Init();
            MSNTNHPhuongAnNhapKhauDialogViewModel.SavedAction = obj => this.OnRefresh();
            MSNTNHPhuongAnNhapKhauDialogViewModel.ShowDialog();
        ...
        private void OnDieuChinh()
        {
            MSNTNHPhuongAnNhapKhauDialogViewModel.Model = SelectedItem;
            MSNTNHPhuongAnNhapKhauDialogViewModel.BIsReadOnly = false;
            MSNTNHPhuongAnNhapKhauDialogViewModel.IsDieuChinh = true;
            MSNTNHPhuongAnNhapKhauDialogViewModel.IsAdd = false;
            MSNTNHPhuongAnNhapKhauDialogViewModel.ILoai = this.ILoai;
            MSNTNHPhuongAnNhapKhauDialogViewModel.Init();
            MSNTNHPhuongAnNhapKhauDialogViewModel.SavedAction = obj => this.OnRefresh();
        ...
        {
            MSNTNHPhuongAnNhapKhauDialogViewModel.Model = SelectedItem;
            MSNTNHPhuongAnNhapKhauDialogViewModel.BIsReadOnly = true;
            MSNTNHPhuongAnNhapKhauDialogViewModel.IsDieuChinh = false;
            MSNTNHPhuongAnNhapKhauDialogViewModel.ILoai = this.ILoai;
            MSNTNHPhuongAnNhapKhauDialogViewModel.Init();
            MSNTNHPhuongAnNhapKhauDialogViewModel.SavedAction = obj => this.OnRefresh();
