...
{
    public class MSNTNHPhuongAnNhapKhauItemDialogViewModel : DetailViewModelBase<NhDaGoiThauChiPhiModel, NhDaGoiThauHangMucModel>
    {
        ...
        public override Type ContentType => typeof(MSNTNHPhuongAnNhapKhauItemDialog);
        ...
        public MSNTNHPhuongAnNhapKhauItemDialogViewModel(IMapper mapper)
        {
            _mapper = mapper;
        ...
        private void OnAddGoiThauHangMuc(object obj)
        {
            ...
            if (sourceItem != null)
            {
                ...
                targetItem.IIdGoiThauChiPhiId = Model.Id;
