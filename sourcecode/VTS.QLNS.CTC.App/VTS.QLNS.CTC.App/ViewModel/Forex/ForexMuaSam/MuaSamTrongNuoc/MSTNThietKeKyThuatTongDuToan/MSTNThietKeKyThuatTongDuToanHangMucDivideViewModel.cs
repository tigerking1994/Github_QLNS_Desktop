...
{
    public class MSTNThietKeKyThuatTongDuToanHangMucDivideViewModel : DetailViewModelBase<VdtDuToanModel, DuToanDetailModel>
    {
        ...
        public MSTNThietKeKyThuatTongDuToanHangMucDivideViewModel()
        {
