...
namespace VTS.QLNS.CTC.App.ViewModel.Forex.ForexMuaSam.MuaSamTrongNuoc.MSTNImportHopDong

{
    public class MSTNImportHopDongViewModel : ViewModelBase
    {
        ...
        public override Type ContentType => typeof(View.Forex.ForexMuaSam.MuaSamTrongNuoc.MSNTNHHopDongTrongNuoc.ImportHopDong.ImportHopDong);
        ...
        public MSTNNHHopDongTrongNuocDialogViewModel NHHopDongTrongNuocDialogViewModel { get; set;}
        ...
        public MSTNImportHopDongViewModel(ISessionService sessionService,
            ILog logger,
            IMapper mapper,
