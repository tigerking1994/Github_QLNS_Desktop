...
{
    public class MSPCNTDecisionIndexViewModel : GridViewModelBase<NhQuyetDinhDamPhamModel>
    {
        ...
        public override Type ContentType => typeof(MSPCNTDecisionIndex);
        ...
        public MSPCNTDecisionDialogViewModel MSPCNTDecisionDialogViewModel { get; set; }

        public MSPCNTDecisionIndexViewModel(
            ILog logger,
            IMapper mapper,
            ...
            MSPCNTDecisionDialogViewModel mspcntdecisionDialogViewModel)
        {
            _logger = logger;
            _mapper = mapper;
        ...
        {
            MSPCNTDecisionDialogViewModel.IsDieuChinh = false;
            MSPCNTDecisionDialogViewModel.BIsReadOnly = false;
            MSPCNTDecisionDialogViewModel.Model = new NhQuyetDinhDamPhamModel();
            MSPCNTDecisionDialogViewModel.ILoai = this.ILoai;
            MSPCNTDecisionDialogViewModel.Init();
            MSPCNTDecisionDialogViewModel.SavedAction = obj => this.OnRefresh();
            MSPCNTDecisionDialogViewModel.ShowDialog();
        }
        ...
        protected override void OnUpdate()
        {
            if (SelectedItem != null)
            {
                MSPCNTDecisionDialogViewModel.IsDieuChinh = false;
                MSPCNTDecisionDialogViewModel.BIsReadOnly = false;
                MSPCNTDecisionDialogViewModel.Model = SelectedItem;
                MSPCNTDecisionDialogViewModel.ILoai = this.ILoai;
                MSPCNTDecisionDialogViewModel.Init();
                MSPCNTDecisionDialogViewModel.SavedAction = obj => this.OnRefresh();
                MSPCNTDecisionDialogViewModel.ShowDialog();
        ...
        protected void OnViewDetail()
        {
            if (SelectedItem != null)
            {
                MSPCNTDecisionDialogViewModel.BIsReadOnly = true;
                MSPCNTDecisionDialogViewModel.IsDieuChinh = false;
                MSPCNTDecisionDialogViewModel.Model = SelectedItem;
                MSPCNTDecisionDialogViewModel.ILoai = this.ILoai;
                MSPCNTDecisionDialogViewModel.Init();
        ...
        private void OnDieuChinh()
        {
            ...
            if (SelectedItem != null)
            {
                MSPCNTDecisionDialogViewModel.IsDieuChinh = true;
                MSPCNTDecisionDialogViewModel.IdDieuChinh = SelectedItem.Id;
                MSPCNTDecisionDialogViewModel.BIsReadOnly = false;
                MSPCNTDecisionDialogViewModel.ILoai = this.ILoai;
