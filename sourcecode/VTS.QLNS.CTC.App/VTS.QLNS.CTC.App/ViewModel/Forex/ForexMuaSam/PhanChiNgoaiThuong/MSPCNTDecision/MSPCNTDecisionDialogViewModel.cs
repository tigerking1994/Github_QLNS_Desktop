...
{
    public class MSPCNTDecisionDialogViewModel : DialogCurrencyAttachmentViewModelBase<NhQuyetDinhDamPhamModel>
    {
        ...
        public override Type ContentType => typeof(MSPCNTDecisionDialog);
        ...
        public MSPCNTDecisionDialogDetailViewModel MSPCNTDecisionDialogDetailViewModel { get; }

        public MSPCNTDecisionDialogViewModel
        (
            ILog logger,
            IMapper mapper,
            ...
            MSPCNTDecisionDialogDetailViewModel mspcntdecisionDialogDetailViewModel
        )
        ...
        private void LoadDuAn()
        {
            ...
            {
                IEnumerable<NhDaDuAn> listDuAn = _nhDaDuAnService.FindAll(s => s.IIdKhttNhiemVuChiId == _selectedChuongTrinh.Id).Where(x => x.ILoai == 1);
        ...
        private void LoadPhuongAnNhapKhau()
        {
            ...
            {
                IEnumerable<NhHdnkPhuongAnNhapKhau> data = _phuongAnNhapKhauService.FindIndex().Where(s => s.IIdDuAnId == _selectedDuAn.Id && s.BIsActive == true && s.ILoai == 2);
            ...
            else
            {
                ...
                if (_selectedChuongTrinh != null)
                {
                    IEnumerable<NhHdnkPhuongAnNhapKhau> data = _phuongAnNhapKhauService.FindIndex().Where(s => s.IIdKhttNhiemVuChiId == _selectedChuongTrinh.Id && s.BIsActive==true && s.ILoai == 2).Where(x => x.SLoaiSoCu == SO_CU_TRUC_TIEP.CHUONG_TRINH);
                    _itemsPhuongAnNhapKhau = _mapper.Map<ObservableCollection<NhHdnkPhuongAnNhapKhauModel>>(data);
                }
            }
        ...
        private bool ValidateData()
        {
            ...
            if(_selectedPhuongAnNhapKhau == null)
            {
                lstError.Add(Resources.MsgCheckPhuongAnNhapKhau);
            }
            ...
            if (Model.DNgayQuyetDinh != null)
            {
                ...
                {
                    lstError.Add(Resources.MsgCheckNgayDeNghiNhoHon);
                } 
            }
        ...
        {
            MSPCNTDecisionDialogDetailViewModel.Model = SelectedGoiThau;
            MSPCNTDecisionDialogDetailViewModel.SoQuetDinhChiTiet = Model.SSoQuyetDinh;
            MSPCNTDecisionDialogDetailViewModel.Init();
            MSPCNTDecisionDialogDetailViewModel.ShowDialog();
        }
