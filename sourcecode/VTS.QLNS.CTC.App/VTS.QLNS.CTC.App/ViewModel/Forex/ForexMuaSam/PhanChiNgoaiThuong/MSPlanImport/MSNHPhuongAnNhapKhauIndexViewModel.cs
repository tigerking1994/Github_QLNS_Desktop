...
{
    public class MSNHPhuongAnNhapKhauIndexViewModel : GridViewModelBase<NhHdnkPhuongAnNhapKhauModel>
    {
        ...
        public override Type ContentType => typeof(MSNHPhuongAnNhapKhauIndex);
        ...
        public MSNHPhuongAnNhapKhauDialogViewModel MSNHPhuongAnNhapKhauDialogViewModel { get; }

        public MSNHPhuongAnNhapKhauIndexViewModel
        (
            ILog logger,
            IMapper mapper,
            ...
            MSNHPhuongAnNhapKhauDialogViewModel msnhPhuongAnNhapKhauDialogViewModel
        )
        {
            _logger = logger;
            _mapper = mapper;
        ...
        {
            MSNHPhuongAnNhapKhauDialogViewModel.Model = new NhHdnkPhuongAnNhapKhauModel();
            MSNHPhuongAnNhapKhauDialogViewModel.BIsReadOnly = false;
            MSNHPhuongAnNhapKhauDialogViewModel.IsDieuChinh = false;
            MSNHPhuongAnNhapKhauDialogViewModel.IsAdd = true;
            MSNHPhuongAnNhapKhauDialogViewModel.ILoai = this.ILoai;
            MSNHPhuongAnNhapKhauDialogViewModel.Init();
            MSNHPhuongAnNhapKhauDialogViewModel.SavedAction = obj => this.OnRefresh();
            MSNHPhuongAnNhapKhauDialogViewModel.ShowDialog();
        }

        protected override void OnUpdate()
        {
            MSNHPhuongAnNhapKhauDialogViewModel.Model = SelectedItem;
            MSNHPhuongAnNhapKhauDialogViewModel.BIsReadOnly = false;
            MSNHPhuongAnNhapKhauDialogViewModel.IsDieuChinh = false;
            MSNHPhuongAnNhapKhauDialogViewModel.IsAdd = false;
            MSNHPhuongAnNhapKhauDialogViewModel.ILoai = this.ILoai;
            MSNHPhuongAnNhapKhauDialogViewModel.Init();
            MSNHPhuongAnNhapKhauDialogViewModel.SavedAction = obj => this.OnRefresh();
            MSNHPhuongAnNhapKhauDialogViewModel.ShowDialog();
        ...
        private void OnDieuChinh()
        {
            MSNHPhuongAnNhapKhauDialogViewModel.Model = SelectedItem;
            MSNHPhuongAnNhapKhauDialogViewModel.BIsReadOnly = false;
            MSNHPhuongAnNhapKhauDialogViewModel.IsDieuChinh = true;
            MSNHPhuongAnNhapKhauDialogViewModel.IsAdd = false;
            MSNHPhuongAnNhapKhauDialogViewModel.ILoai = this.ILoai;
            MSNHPhuongAnNhapKhauDialogViewModel.Init();
            MSNHPhuongAnNhapKhauDialogViewModel.SavedAction = obj => this.OnRefresh();
        ...
        {
            MSNHPhuongAnNhapKhauDialogViewModel.Model = SelectedItem;
            MSNHPhuongAnNhapKhauDialogViewModel.BIsReadOnly = true;
            MSNHPhuongAnNhapKhauDialogViewModel.IsDieuChinh = false;
            MSNHPhuongAnNhapKhauDialogViewModel.ILoai = this.ILoai;
            MSNHPhuongAnNhapKhauDialogViewModel.Init();
            MSNHPhuongAnNhapKhauDialogViewModel.SavedAction = obj => this.OnRefresh();
