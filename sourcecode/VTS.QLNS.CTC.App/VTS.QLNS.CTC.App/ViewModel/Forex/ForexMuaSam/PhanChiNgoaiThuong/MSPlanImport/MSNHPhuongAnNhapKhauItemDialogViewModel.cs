...
{
    public class MSNHPhuongAnNhapKhauItemDialogViewModel : DetailViewModelBase<NhDaGoiThauChiPhiModel, NhDaGoiThauHangMucModel>
    {
        ...
        public override Type ContentType => typeof(MSNHPhuongAnNhapKhauItemDialog);
        ...
        public MSNHPhuongAnNhapKhauItemDialogViewModel(IMapper mapper)
        {
            _mapper = mapper;
        ...
        public override void LoadData(params object[] args)
        {
            ...
            var data = Model.GoiThauHangMucs.OrderBy(s => s.SMaOrder).ToList();
            data.ForEach(x =>
            {
