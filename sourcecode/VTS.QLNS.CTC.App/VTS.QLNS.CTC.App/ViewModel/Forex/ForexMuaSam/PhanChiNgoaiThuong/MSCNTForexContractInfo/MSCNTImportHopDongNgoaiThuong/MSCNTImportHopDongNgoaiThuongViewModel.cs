...
namespace VTS.QLNS.CTC.App.ViewModel.Forex.ForexMuaSam.PhanChiNgoaiThuong.MSCNTForexContractInfo.MSCNTImportHopDongNgoaiThuong
{
    public class MSCNTImportHopDongNgoaiThuongViewModel : ViewModelBase
    {
        ...
        public MSCNTImportHopDongNgoaiThuongViewModel(ISessionService sessionService,
            ILog logger,
            IMapper mapper,
        ...
        {
            var lst = _nhDaHopDongService.FindAllHopDongNgoaiThuong(5);
