...
{
    public class ClearDataRedundancyDialogViewModel : ViewModelBase
    {
        ...
        public override Type ContentType => typeof(ClearDataRedundancyDialog);
        ...
        private ObservableCollection<ErrorDatabaseLog> _errorDatabaseLogs;
        public ObservableCollection<ErrorDatabaseLog> ErrorDatabaseLogs
        {
            get => _errorDatabaseLogs;
            set => SetProperty(ref _errorDatabaseLogs, value);
        }

        public ClearDataRedundancyDialogViewModel(
            ILog logger,
        ...
        {
            ErrorDatabaseLogs = new ObservableCollection<ErrorDatabaseLog>(_errorDatabaseLogService.FindAllByToday());
        }
    }
}
