...
namespace VTS.QLNS.CTC.App.View.Forex.ForexMuaSam.MuaSamNgoaiThuong.MSNTThietKeKyThuatTongDuToan
{
    /// <summary>
    ...
    public partial class ThietKeKyThuatTongDuToanDialog : Window
    {
        ...
        {
            var vm = (MSNTThietKeKyThuatTongDuToanDialogViewModel)DataContext;
