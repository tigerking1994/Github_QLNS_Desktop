...
namespace VTS.QLNS.CTC.App.View.Forex.ForexMuaSam.MuaSamNgoaiThuong.MSNTDecision
{
    /// <summary>
    /// Interaction logic for DecisionHangMucDetailDialog.xaml
    /// </summary>
    public partial class MSNTDecisionHangMucDetailDialog : Window
    {
        public MSNTDecisionHangMucDetailDialog()
        {
            InitializeComponent();
        }
        ...
        {
            var vm = (MSNTDecisionHangMucDetailDialogViewModel)this.DataContext;
