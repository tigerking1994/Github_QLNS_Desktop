...
namespace VTS.QLNS.CTC.App.View.SocialInsurance.SocialInsuranceSettlement.QuyetToanChiNamKCB.Import
{
    /// <summary>
    /// Interaction logic for ImportKhtBHXH.xaml
    /// </summary>
    public partial class ImportQuyetToanChiNamKCB : Window
    {
        public ImportQuyetToanChiNamKCB()
        {
            InitializeComponent();
        }
