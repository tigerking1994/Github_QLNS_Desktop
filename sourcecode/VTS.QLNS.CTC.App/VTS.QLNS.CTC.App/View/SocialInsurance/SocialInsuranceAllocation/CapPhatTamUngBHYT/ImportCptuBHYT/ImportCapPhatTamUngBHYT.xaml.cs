...
namespace VTS.QLNS.CTC.App.View.SocialInsurance.SocialInsuranceAllocation.CapPhatTamUngBHYT.ImportCptuBHYT
{
    /// <summary>
    /// Interaction logic for ImportKhtBHXH.xaml
    /// </summary>
    public partial class ImportCapPhatTamUngBHYT : Window
    {
        public ImportCapPhatTamUngBHYT()
        {
            InitializeComponent();
        }
